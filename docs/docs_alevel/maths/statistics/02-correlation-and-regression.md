...
description:
  "A-Level Mathematics notes on Correlation and Regression: Board Coverage; 1. Pearson's Product Moment Correlation Coefficient (PMCC); 1.1 Definition; 1.2 Prop."
...
:::tip Diagnostic Test
Ready to test your understanding of **Correlation and Regression**? The [diagnostic test](/maths/diagnostics/diag-correlation-and-regression) contains the hardest questions within the A-Level specification for this topic, each with a full worked solution.
