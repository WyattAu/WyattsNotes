...
title: Kinematics
description:
  'A-Level Maths Kinematics notes covering key definitions, core concepts, worked examples, and
  practice questions for rigorous revision and exam readiness.'
...
[diagnostic test](/docs/alevel/maths/diagnostics/diag-kinematics) contains the hardest questions
