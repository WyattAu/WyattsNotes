...
- The sample mean $\bar{X} = \frac{T}{n}$ is then approximately
  $N\left(\lambda, \frac{\lambda}{n}\right) = N\left(8, \frac{160}{400}\right) = N(8, 0.4)$.
...
For Study 1:
$t = -0.52\sqrt{\frac{13}{1-0.2704}} = -0.52\sqrt{17.81} = -0.52 \times 4.22 = -2.19$

For Study 2:
$t = -0.31\sqrt{\frac{38}{1-0.0961}} = -0.31\sqrt{42.06} = -0.31 \times 6.49 = -2.01$
