...
$f\!\left(-\sqrt{2/3}\right) = -\frac◆LB◆2\sqrt{6}◆RB◆◆LB◆9◆RB◆ + \frac◆LB◆2\sqrt{6}◆RB◆◆LB◆3◆RB◆ + 2 = \frac◆LB◆4\sqrt{6}◆RB◆◆LB◆9◆RB◆ + 2 \approx 3.09$
(local maximum).

$f\!\left(\sqrt{2/3}\right) = \frac◆LB◆2\sqrt{6}◆RB◆◆LB◆9◆RB◆ - \frac◆LB◆2\sqrt{6}◆RB◆◆LB◆3◆RB◆ + 2 = -\frac◆LB◆4\sqrt{6}◆RB◆◆LB◆9◆RB◆ + 2 \approx 0.91$
(local minimum).
...
**(c)** The exact value of the integral is $\frac◆LB◆4\sqrt{2}◆RB◆◆LB◆3◆RB◆$. Calculate the
