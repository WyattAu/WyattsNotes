...
description:
  'A-Level Psychology diagnostic test covering all 8 core topics: Research Methods, Social
  Influence, Memory, Attachment, Psychopathology, Approaches, Biopsychology, and Issues and Debates.'
tags:
  - Psychology
  - A-Level
---
...
<DiagnosticTest subject="A-Level Psychology" questions={questions} onComplete={handleComplete} />
...
| ------------------ | --------- | ------------------------------------------------------------------- |
| Research Methods   | 3         | [Research Methods](/docs/alevel/psychology/1-research-methods/)     |
| Social Influence   | 3         | [Social Influence](/docs/alevel/psychology/2-social-influence/)     |
| Memory             | 3         | [Memory](/docs/alevel/psychology/3-memory/)                         |
| Attachment         | 2         | [Attachment](/docs/alevel/psychology/4-attachment/)                 |
| Psychopathology    | 2         | [Psychopathology](/docs/alevel/psychology/5-psychopathology/)       |
| Approaches         | 3         | [Approaches](/docs/alevel/psychology/6-approaches/)                 |
| Biopsychology      | 2         | [Biopsychology](/docs/alevel/psychology/7-biopsychology/)           |
| Issues and Debates | 2         | [Issues and Debates](/docs/alevel/psychology/8-issues-and-debates/) |
