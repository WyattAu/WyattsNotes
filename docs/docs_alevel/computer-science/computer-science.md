...
description:
  'A-Level Computer Science notes on Computer Science: Board Coverage; Course Structure; Assessment;
  How to Use These Notes with worked examples and exam-style.'
