...
title: Testing
description:
  'A-Level Computer Science notes on Testing: Definition; Why Test?; Verification vs Validation;
  Equivalence Partitioning with worked examples and exam-style qu.'
