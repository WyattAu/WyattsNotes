...
description:
  'A-Level Computer Science notes on Relational Databases: 1. The Relational Model; Definition;
  Terminology; Keys with worked examples and exam-style questions.'
