...
categories:
  - History
slug: a-level-historical-methods
sidebar_position: 10
---
...
1. **New evidence**: The discovery of new primary sources -- archival documents, archaeological finds, statistical data -- can overturn established interpretations. The opening of Soviet archives after 1991, for example, fundamentally reshaped understanding of the origins of the Cold War.

2. **New questions**: Historians of different eras ask different questions of the past. Twentieth-century historians, influenced by Marxism and social history, asked about the experiences of ordinary people, class structures, and economic forces -- questions that earlier historians, focused on political and diplomatic history, had largely ignored.

3. **New theoretical frameworks**: The development of new approaches -- Marxist history, Annales School, feminist history, postcolonial history, cultural history -- has provided new lenses through which to view the past.

4. **Contemporary influences**: Historians are influenced by the events and concerns of their own time. The experience of the Vietnam War shaped interpretations of earlier conflicts; the end of the Cold War prompted reassessment of its origins and course.

5. **Generational change**: Each generation of historians revises the work of its predecessors, identifying errors, uncovering neglected evidence, and applying new perspectives.
...
1. **Impact**: How profound and wide-ranging were the consequences? Did the event affect large numbers of people, fundamentally alter political structures, or reshape economic systems?
2. **Duration**: How long-lasting were the effects? Did the event have a lasting legacy, or were its consequences short-lived?
3. **Revelation**: Does the event reveal something important about broader historical trends, social structures, or political dynamics?
4. **Resonance**: Did the event have symbolic or cultural importance? Has it been remembered, commemorated, or invoked by later generations?
5. **Novelty**: Was the event unprecedented, or did it represent a departure from established patterns?
6. **Subsequent importance**: Did the event set in motion further developments of major significance?
...
1. **A clear thesis**: A precise statement of the interpretation being advanced.
2. **Structured evidence**: Factual material organised to support the thesis, with each point linked to the overall argument.
3. **Engagement with alternative views**: Acknowledging and addressing interpretations that differ from your own.
4. **A substantiated judgement**: A conclusion that weighs the evidence and reaches a reasoned conclusion.
...
1. **Introduction**: Define the event and identify the key factors to be discussed. State your thesis about which factors were most significant and why.

2. **Long-term causes**: Discuss the deep structural factors that created the conditions for the event. Provide specific evidence (dates, statistics, names) and explain how each factor contributed.

3. **Short-term causes**: Discuss the more immediate factors that precipitated the event. Explain how they interacted with the long-term causes.

4. **Triggers**: Identify the specific event or decision that directly initiated the development. Explain why it was a trigger and not simply another short-term cause.

5. **Counterarguments**: Address alternative interpretations. If your thesis emphasises economic causes, acknowledge the role of political or ideological factors and explain why you consider them less significant.

6. **Conclusion**: Reach a substantiated judgement about the relative importance of the different causes. Be specific: do not simply say "all factors were important" but explain the relationship between them and the hierarchy of causation.
...
1. **Define significance**: Establish the criteria you will use to assess significance. These might include impact, duration, novelty, resonance, and subsequent importance.

2. **Assess against each criterion**: For each criterion, provide specific evidence of the event's or individual's significance. Be precise: do not simply state that the event was "significant" but explain exactly how and why.

3. **Compare with alternatives**: Where appropriate, compare the significance of the event or individual with other candidates. If the question asks about the significance of the Beveridge Report, for example, consider whether other factors (such as the experience of total war or the election of the Labour government) were equally or more significant in creating the welfare state.

4. **Address counterarguments**: Acknowledge limitations to the significance you have identified. Were the effects of the event concentrated in certain areas or among certain groups? Were they subsequently reversed or modified?

5. **Conclusion**: Reach a clear, substantiated judgement about the overall significance of the event or individual, supported by the evidence you have presented.
...
1. **Establish the baseline**: Describe the situation at the start of the period. What were the key features of the political, social, economic, or cultural landscape?

2. **Identify changes**: Describe the major developments that occurred during the period. For each change, provide specific evidence (dates, statistics, legislation, events) and explain its significance.

3. **Identify continuities**: Identify the aspects of the political, social, economic, or cultural landscape that remained fundamentally unchanged. Explain why these continuities persisted.

4. **Assess the nature of change**: How rapid was the change? Was it sudden or gradual? How deep was it? Did it transform fundamental structures, or was it largely superficial? How widespread was it? Did it affect all sections of society?

5. **Conclusion**: Reach a judgement about the overall balance of change and continuity. Was the period characterised primarily by change or by continuity? Which changes were most significant, and which continuities were most important?

### Applying Similarity and Difference in Essays

Comparative questions require a systematic approach:

1. **Establish the dimensions of comparison**: Identify the specific aspects along which you will compare the two (or more) cases. These might include political structures, economic systems, social relations, ideological orientations, or international positions.

2. **Discuss similarities**: For each dimension, identify the similarities between the cases. Provide specific evidence and explain the significance of the similarities.

3. **Discuss differences**: For each dimension, identify the differences between the cases. Provide specific evidence and explain the significance of the differences.

4. **Explain the similarities and differences**: Why do the similarities and differences exist? Are they the product of common structural factors, divergent historical experiences, different ideological orientations, or different external pressures?

5. **Conclusion**: Reach a judgement about the overall balance of similarity and difference. Are the cases more similar or more different? Which similarities and differences are most significant, and why?
