...
At $I = 50$: $P = \frac{20 \times 50}{50 + 50} = \frac{1000}{100} = 10\ \mu\mathrm{mol\ CO_2\ m^{-2}\ s^{-1}}$ (half of $P_{\max}$, as expected).

At $I = 200$: $P = \frac{20 \times 200}{50 + 200} = \frac{4000}{250} = 16\ \mu\mathrm{mol\ CO_2\ m^{-2}\ s^{-1}}$.

At $I = 1000$: $P = \frac{20 \times 1000}{50 + 1000} = \frac{20000}{1050} = 19.0\ \mu\mathrm{mol\ CO_2\ m^{-2}\ s^{-1}}$ (approaching $P_{\max}$).
