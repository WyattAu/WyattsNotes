...
- **Induced fit:** active site changes shape slightly upon substrate binding, improving the fit
  (current model)

### Activation Energy

Enzymes **lower the activation energy** ($E_a$) of a reaction by providing an alternative pathway
but do **not** change the $\Delta H$ or equilibrium position.
...
4. **Confusing DNA and RNA.** Key differences: RNA is single-stranded, has ribose (not deoxyribose),
   and uses uracil (not thymine).

5. **Stating ATP "stores energy."** ATP transfers energy rapidly; it is a short-term energy carrier,
   not a long-term store (that role belongs to lipids/glycogen/starch).
