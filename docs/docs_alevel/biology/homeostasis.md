...
- **Hyperthermophiles** (e.g., _Thermus aquaticus_, source of Taq polymerase): enzymes with high optimum temperatures and enhanced thermal stability (more disulfide bonds, more hydrophobic interactions, more salt bridges).
...
For detailed cardiac cycle mechanics, see [Exchange and Transport](/docs/alevel/biology/exchange-and-transport).
...
1. Insulin binds to the $\alpha$-subunits of the receptor, causing the $\beta$-subunits to autophosphorylate (add phosphate groups to their own tyrosine residues).
