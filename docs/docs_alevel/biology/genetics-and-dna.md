...
2. **Elongation**:
 - A charged tRNA carrying the next amino acid enters the A site, matching its **anticodon** to
 the mRNA **codon**.
 ...
 - The ribosome translocates one codon along the mRNA: the empty tRNA moves to the E site and
 exits, the tRNA carrying the growing polypeptide moves from A to P, and a new tRNA enters A.
...
Which shifts the reading frame downstream. All codons after the mutation are changed, 
Producing a completely non-functional protein.
...
Passed to daughter cells during mitosis (and meiosis), but they can also be removed by
...
Longer, non-functional protein. This illustrates why frameshift mutations are more severe than
Point mutations.
...
**Answer.** Colour blindness is X-linked recessive ($X^c$). The son is $X^cY$Having inherited
$X^c$ from his mother. The mother must therefore be a carrier: $X^CX^c$. The woman's father was
$X^cY$So she inherited $X^c$ from him. The father has normal vision and is $X^CY$ (since he is not
...
Degeneracy is not random: the first two bases of a codon are more important than the third. Mutations at the third position (wobble position) are more likely to be silent.
...
- **Symptoms:** progressive neurodegeneration (especially in the striatum); involuntary movements (chorea); cognitive decline; psychiatric symptoms (depression, psychosis). Onset 35--45 years; death 15--20 years after onset.
...
Restriction enzymes are bacterial enzymes that cut DNA at specific recognition sequences ( palindromic, 4--8 base pairs):
...
- Two primers (short, single-stranded DNA sequences, 18--25 nucleotides, complementary to the sequences flanking the target).
