...
description:
  A-Level Biology notes on Genetics and DNA: 1. DNA Structure and Replication;
  1.1 The Structure of DNA; 1.2 DNA Replication; 2. Protein Synthesis.
...
- **Nonsense mutation**: the new codon is a stop codon. This causes premature termination of
  translation, producing a truncated, usually non-functional protein.

**Frameshift mutations**: insertion or deletion of a base (or bases not in multiples of three),
which shifts the reading frame downstream. All codons after the mutation are changed, typically
