  ...
  questions={[
    {
      ...
      correct: 2,
      explanation:
        'The emulsion test identifies lipids: dissolve the sample in ethanol, then pour the ethanol solution into water. If lipids are present, a cloudy white emulsion forms because lipids are insoluble in water but soluble in ethanol, creating tiny droplets that scatter light.',
    },
    {
      ...
      correct: 1,
      explanation:
        'Each fatty acid joins to glycerol through a condensation reaction forming an ester bond and releasing one molecule of water. A triglyceride has three fatty acids joined to one glycerol molecule by three ester bonds. The process can be reversed by hydrolysis, which requires lipase enzyme.',
    },
    {
      question:
        'Phospholipids are essential components of cell membranes. How does the structure of a phospholipid differ from that of a triglyceride?',
      options: [
        'A) A phospholipid has three fatty acid tails instead of three',
        'B) A phospholipid has a phosphate group replacing one fatty acid, making the molecule have a hydrophilic head and hydrophobic tail',
        'C) A phospholipid has only one fatty acid tail attached to glycerol',
        'D) A phospholipid uses beta-glucose instead of glycerol as its backbone',
      ],
      correct: 1,
      explanation:
        'A phospholipid has two fatty acid tails (hydrophobic) and a phosphate group attached to glycerol (hydrophilic). This amphipathic structure -- with a polar hydrophilic head and non-polar hydrophobic tails -- allows phospholipids to form bilayers in water, which is the basis of all cell membranes. A triglyceride has three fatty acid tails and no phosphate group, so it is entirely hydrophobic.',
    },
  ]}
/>
  ...
  questions={[
    {
      ...
      options: [
        ...
        'D) The number of polypeptide chains in the protein',
      ],
      correct: 1,
      explanation:
        'The primary structure is the specific sequence of amino acids in a polypeptide chain, joined by peptide bonds. This sequence is coded for by DNA and determines how the protein will fold into secondary and tertiary structures. Secondary structure involves hydrogen bonds, tertiary structure involves various bonds and interactions, and quaternary structure involves multiple polypeptide chains.',
    },
    {
      question:
        'Which type of bond is NOT involved in maintaining the tertiary structure of a protein?',
      options: ['A) Hydrogen bonds', 'B) Disulfide bonds', 'C) Ionic bonds', 'D) Glycosidic bonds'],
      correct: 3,
      explanation:
        'The tertiary structure is stabilised by hydrogen bonds between R groups, ionic (electrostatic) bonds between charged R groups, disulfide bridges (covalent bonds between two cysteine amino acids), and hydrophobic interactions between non-polar R groups that cluster away from water. Glycosidic bonds join monosaccharides in carbohydrates and are not found in proteins.',
    },
    {
      question: 'Haemoglobin is an example of which level of protein structure?',
      options: ['A) Primary only', 'B) Secondary', 'C) Tertiary', 'D) Quaternary'],
      correct: 3,
      explanation:
        'Haemoglobin has a quaternary structure because it is composed of four polypeptide chains (two alpha and two beta chains), each with its own tertiary structure, plus four haem groups. The quaternary structure describes how multiple polypeptide subunits assemble into a functional protein. A protein with only one polypeptide chain can have at most tertiary structure.',
    },
  ]}
/>
  ...
  questions={[
    {
      ...
      correct: 3,
      explanation:
        'RNA contains uracil (U) instead of thymine (T). Adenine, guanine, and cytosine are found in both DNA and RNA. In DNA, adenine pairs with thymine (A-T via 2 hydrogen bonds); in RNA, adenine pairs with uracil (A-U via 2 hydrogen bonds). Guanine pairs with cytosine in both (G-C via 3 hydrogen bonds).',
    },
    {
      ...
      options: [
        ...
        'B) The entire DNA molecule is newly synthesised',
        'C) One new DNA molecule is synthesised while the original is preserved unchanged',
        'D) Half of the bases in each new DNA molecule are newly synthesised',
      ],
      correct: 0,
      explanation:
        'Semi-conservative replication means that when DNA replicates, each of the two daughter DNA molecules contains one original (parent) strand and one newly synthesised strand. This was demonstrated by the Meselson-Stahl experiment (1958) using heavy and light nitrogen isotopes to distinguish old and new DNA strands.',
    },
    {
      question: 'A DNA molecule has 20% adenine. What percentage of cytosine does it contain?',
  ...
  questions={[
    {
      ...
      correct: 1,
      explanation:
        'The induced fit model (Koshland, 1958) proposes that the active site is not a rigid lock but is flexible. When the substrate binds, the active site changes shape slightly to mould around the substrate, straining bonds in the substrate to lower the activation energy. The enzyme returns to its original shape after the products are released. This supersedes the older lock-and-key model.',
    },
    {
      question:
        'A competitive inhibitor is most similar in structure to which component of the enzyme-substrate complex?',
      options: [
...
<PracticeProblem
  questions={[
    {
      question: "A positive Benedict's test for reducing sugars produces which colour change?",
      options: [
