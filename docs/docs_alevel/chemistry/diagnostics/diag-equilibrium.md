...
description:
  Diagnostic tests for Le Chatelier's principle, Kc, Kp, and industrial processes at the hardest
...
$\ln(K_2/K_1) \approx \frac◆LB◆\Delta H^\circ◆RB◆◆LB◆R◆RB◆\left(\frac{1}{T_1} - \frac{1}{T_2}\right)$.
...
$$T = \frac◆LB◆\Delta H^\circ◆RB◆◆LB◆\Delta S^\circ◆RB◆ = \frac{-41000}{-0.042} = 976\,\mathrm{K}$$
(1 mark).
