...
description:
  'A-Level Chemistry notes on Electrochemistry: Redox Reactions; Oxidation States (Oxidation
  Numbers); Half-Equations for thorough revision and examination prep.'
...
:::tip Diagnostic Test Ready to test your understanding of **Electrochemistry**? The
[diagnostic test](/docs/alevel/chemistry/diagnostics/diag-electrochemistry) contains the hardest
