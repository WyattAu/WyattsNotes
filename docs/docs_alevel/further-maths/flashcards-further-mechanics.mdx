...
description: "20 interactive flashcards for A-Level Further Maths mechanics covering SHM, damped and forced oscillations, circular motion, gravitation, orbits, impulse and dimensional analysis for spaced repetition revision."
tags:
  - Further Maths
  - A-Level
  - Flashcards
...
<FlashcardDeck
  ...
  cards={[
    {
      id: 'shm-derivation',
      front: 'Derive the equation of SHM for a mass on a spring (Hooke\'s law) and for a simple pendulum.',
    ...
    {
      id: 'shm-energy',
      front: 'Derive the energy equations for SHM and state the total energy in terms of mass, angular velocity and amplitude.',
    ...
    },
    {
      ...
      front: 'Describe forced oscillations and the effect of the driving frequency on the amplitude of oscillation.',
    ...
    {
      id: 'grav-field',
      front: 'State Newton\'s law of gravitation and the equations for gravitational field strength and gravitational potential.',
    ...
    {
      id: 'escape-vel',
      front: 'Derive the escape velocity formula and calculate it for Earth. (M_E = 5.97 × 10²⁴ kg, R_E = 6.37 × 10⁶ m, G = 6.67 × 10⁻¹¹ N m²/kg²)',
    ...
    {
      id: 'orbital-period',
      front: 'Derive the orbital period formula for a satellite in circular orbit and calculate the period of a geostationary satellite.',
    ...
    {
      id: 'variable-force',
      front: 'A particle of mass m moves under a variable force F = 3x² (in newtons, x in metres). Find the work done moving from x = 1 to x = 3 and the velocity gained.',
    ...
    {
      id: 'dim-analysis-use',
      front: 'How can dimensional analysis be used to check the correctness of a physical equation or to derive a formula?',
    ...
    },
    {
      ...
      front: 'State the conditions for an elastic collision and the relationship between coefficient of restitution and relative velocities.',
    ...
    },
    {
      ...
      front: 'Describe the criteria for the stability of equilibrium for a body and relate to the position of the centre of mass.',
    ...
    {
      id: 'banked-curve',
      front: 'Derive the expression for the ideal banking angle of a road curve for a vehicle travelling at speed v without relying on friction.',
    ...
    {
      id: 'grav-pe-work',
      front: 'Explain the difference between gΔh and GMm(1/r₁ - 1/r₂) for gravitational potential energy changes.',
    ...
    {
      id: 'energy-in-damped',
      front: 'Describe how total mechanical energy decreases in a damped oscillator and relate it to the damping constant.',
