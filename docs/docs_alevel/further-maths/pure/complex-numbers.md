...
$\theta_1 = \arctan\!\left(\dfrac{\sqrt{3}}{1}\right) = \dfrac{\pi}{3}$.
...
$k = 2$:
$z_2 = 2\!\left(\cos\dfrac{5\pi}{3} + i\sin\dfrac{5\pi}{3}\right) = 1 - i\sqrt{3}$
...
**(b)**
$\dfrac{z_1^4}{z_2^2} = \dfrac{(\sqrt{2})^4\,e^{i\pi}}{2^2\,e^{-i2\pi/3}} = \dfrac{4\,e^{i\pi}}{4\,e^{-i2\pi/3}} = e^{i5\pi/3}$.

In Cartesian form:
$e^{i5\pi/3} = \cos\dfrac{5\pi}{3} + i\sin\dfrac{5\pi}{3} = \dfrac{1}{2} - i\dfrac{\sqrt{3}}{2}$.
...
$3e^{i11\pi/6} = 3\!\left(\dfrac{\sqrt{3}}{2} - \dfrac{i}{2}\right)$.

**(b)** Sum
$= 3i + 3\!\left(-\dfrac{\sqrt{3}}{2} - \dfrac{i}{2}\right) + 3\!\left(\dfrac{\sqrt{3}}{2} - \dfrac{i}{2}\right) = 3i - 3i/2 - 3i/2 = 0$.
$\blacksquare$
...
$\cos^n\theta = \left(\dfrac{e^{i\theta}+e^{-i\theta}}{2}\right)^n$ and
$\sin^n\theta = \left(\dfrac{e^{i\theta}-e^{-i\theta}}{2i}\right)^n$.
...
$\displaystyle\sum_{k=0}^{n-1} r^k = \frac{r^n - 1}{r - 1} = \frac{e^{2\pi i} - 1}{e^{2\pi i/n} - 1} = \frac{1 - 1}{e^{2\pi i/n} - 1} = 0$.
$\blacksquare$
