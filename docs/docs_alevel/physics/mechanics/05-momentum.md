...
**Answer.**
$v_2 = \frac{2m_1 u_1}{m_1 + m_2} = \frac{2m \cdot v}{m + 12m} = \frac{2v}{13}$.
...
Substituting:
$u = \frac{\sqrt{3}}{2}(\sqrt{3}v_2) + \frac{v_2}{2} = \frac{3v_2}{2} + \frac{v_2}{2} = 2v_2$.
...
$v_a = -\frac{m_t v_t}{m_a} = -\frac{2.0 \times 8.0}{60} = -0.267$ m s$^{-1}$ (opposite
to the Throw).
...
**Answer.** Speed just before impact: $v_1 = \sqrt{2g \times 5.0} = \sqrt{98.1} = 9.90$ m
s$^{-1}$ (downward, so $u_1 = -9.90$).

Speed just after impact: $v_2 = \sqrt{2g \times 3.2} = \sqrt{62.78} = 7.92$ m s$^{-1}$
(upward).
...
$\tan\beta = \frac{u\sin\alpha}{eu\cos\alpha} = \frac{\tan\alpha}{e}$Which
