...
description: "20 interactive flashcards covering A-Level Physics mechanics and waves topics including SUVAT, Newton's laws, SHM, wave equations, quantum physics and thermal physics for spaced repetition revision."
tags:
  - Physics
  - A-Level
  - Flashcards
...
<FlashcardDeck
  ...
  cards={[
    ...
    {
      id: 'momentum-1',
      front: 'State the principle of conservation of linear momentum and the impulse-momentum equation.',
    ...
    {
      id: 'shm-1',
      front: 'Define simple harmonic motion and state the equations for displacement, velocity and acceleration.',
    ...
    {
      id: 'wave-1',
      front: 'State the wave equation and define all terms. What is the relationship between frequency, period and wavelength?',
    ...
    {
      id: 'diff-1',
      front: 'What conditions must be met for observable diffraction? How does slit width affect the diffraction pattern?',
    ...
    {
      id: 'photo-1',
      front: 'State the photoelectric equation and explain each term. What does it predict about threshold frequency?',
    ...
    {
      id: 'latent-heat-1',
      front: 'Explain why the temperature of a substance remains constant during a change of state using kinetic theory.',
    ...
    {
      id: 'circular-1',
      front: 'State the equations for circular motion including angular velocity, centripetal acceleration and centripetal force.',
    ...
    {
      id: 'doppler-1',
      front: 'State the Doppler effect equation for a moving source and explain the red shift of light from distant galaxies.',
    ...
    {
      id: 'shm-energy-1',
      front: 'Describe the energy changes during one complete oscillation of a mass-spring system in SHM.',
    ...
    {
      id: 'standing-waves-1',
      front: 'Describe the features of standing waves and state the conditions for standing waves on a string fixed at both ends.',
    ...
    {
      id: 'em-spectrum-1',
      front: 'List the regions of the electromagnetic spectrum in order of increasing wavelength and state the typical wavelength ranges for visible light and X-rays.',
