...
description:
  Diagnostic tests covering SUVAT equations, projectile motion, displacement-time and velocity-time
  graphs, and relative motion at maximum A-Level difficulty.
...
$$35 = 25.38t - \frac{1}{2}(9.81)t^2$$ $$4.905t^2 - 25.38t + 35 = 0$$
