...
Without the middle polariser, at $\theta = 90^\circ$ the transmitted intensity would be zero (crossed polarisers). The insertion of a third polariser at $45^\circ$ allows light to pass through, demonstrating that polarisers project the electric field onto their transmission axis rather than blocking light.
