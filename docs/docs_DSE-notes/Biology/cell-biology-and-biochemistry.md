...
For every 3 $\text{CO}_2$ molecules fixed: 1 molecule of glucose (6C) is produced.
...
- For membrane transport, clearly state whether energy is required and the direction of movement
