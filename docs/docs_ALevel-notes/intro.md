...
2. **Work through the proofs.** Don't skip them — understanding _why_ a result holds is what separates grade A\* students from the rest.
...
- **[Mathematics](/docs/docs_ALevel-notes/maths/maths)** — Pure mathematics, statistics, and mechanics
- **[Physics](/docs/docs_ALevel-notes/physics/physics)** — Mechanics, waves, electricity, fields, thermal, nuclear, and astrophysics
- **[Computer Science](/docs/docs_ALevel-notes/computer-science/computer-science)** — Fundamentals, data structures, algorithms, programming, and theory
- **[Economics](/docs/docs_ALevel-notes/economics/economics)** — Microeconomics and macroeconomics
