...
Using the trigonometric identity $\sin\alpha + \sin\beta = 2\sin\frac{\alpha+\beta}{2}\cos\frac{\alpha-\beta}{2}$:
...
- **Constructive interference**: $\Delta\phi = 0, 2\pi, 4\pi, \ldots \implies A_{\text{resultant}} = 2A$
- **Destructive interference**: $\Delta\phi = \pi, 3\pi, 5\pi, \ldots \implies A_{\text{resultant}} = 0$
...
Two waves from independent sources (e.g., two light bulbs) are generally not coherent because the phase difference fluctuates randomly. Interference requires coherent sources, typically produced by splitting a single wave.
:::
...
:::tip Exam Technique
When asked to describe Young's experiment, always mention: coherent source (single slit before the double slit), narrow slits, monochromatic light, and the small-angle approximation. Quote the fringe spacing formula and explain each variable.
:::
...
**Answer.** $\Delta w = \frac{\lambda D}{s} = \frac{590 \times 10^{-9} \times 1.5}{0.50 \times 10^{-3}} = \frac{8.85 \times 10^{-7}}{5.0 \times 10^{-4}} = 1.77 \times 10^{-3}$ m $= 1.77$ mm.
...
:::tip Exam Technique
If asked to find the number of visible orders: calculate $d/\lambda$, take the integer part, then note that orders $+n$ and $-n$ are both visible (plus the zeroth order). Total visible maxima $= 2n_{\max} + 1$.
:::
...
<b>If you get this wrong, revise:</b> [Path Difference and Phase Difference](#2-path-difference-and-phase-difference)
...
**Answer.** $\lambda = \frac{s \cdot \Delta w}{D} = \frac{0.40 \times 10^{-3} \times 2.8 \times 10^{-3}}{2.0} = \frac{1.12 \times 10^{-6}}{2.0} = 5.6 \times 10^{-7}$ m $= 560$ nm.

<b>If you get this wrong, revise:</b> [Young's Double Slit Experiment](#3-youngs-double-slit-experiment)
...
**Answer.** $d = 1/500$ mm $= 2.0 \times 10^{-6}$ m. $d\sin\theta = 2\lambda$. $\sin\theta = \frac{2 \times 600 \times 10^{-9}}{2.0 \times 10^{-6}} = \frac{1.2 \times 10^{-6}}{2.0 \times 10^{-6}} = 0.60$. $\theta = \arcsin(0.60) = 36.9°$.
...
<b>If you get this wrong, revise:</b> [Harmonics on a String Fixed at Both Ends](#harmonics-on-a-string-fixed-at-both-ends)
...
<b>If you get this wrong, revise:</b> [Harmonics in a Pipe Closed at One End](#harmonics-in-a-pipe-closed-at-one-end)
...
<b>If you get this wrong, revise:</b> [Constructive and Destructive Interference](#constructive-and-destructive-interference)
...
<b>If you get this wrong, revise:</b> [Derivation from Superposition of Two Progressive Waves](#derivation-from-superposition-of-two-progressive-waves)
...
**Answer.** $s = \frac{\lambda D}{\Delta w} = \frac{550 \times 10^{-9} \times 1.5}{1.1 \times 10^{-3}} = \frac{8.25 \times 10^{-7}}{1.1 \times 10^{-3}} = 7.5 \times 10^{-4}$ m $= 0.75$ mm.
...
**Answer.** $f_4 = \frac{4v}{2L} = \frac{2v}{L}$. $v = \frac{f_4 L}{2} = \frac{400 \times 0.60}{2} = 120$ m s$^{-1}$.
...
For 400 nm: $\sin\theta = \frac{2 \times 400 \times 10^{-9}}{2.5 \times 10^{-6}} = 0.320$, $\theta = 18.7°$.

For 700 nm: $\sin\theta = \frac{2 \times 700 \times 10^{-9}}{2.5 \times 10^{-6}} = 0.560$, $\theta = 34.1°$.
