...
where $Z$ is the number of protons, $N$ is the number of neutrons, $m_p$ is the proton mass, $m_n$ is the neutron mass, and $m_{\text{nucleus}}$ is the actual nuclear mass.
...
**Calculating mass defect.** Use atomic mass units (u), where $1\,\text{u} = 1.661 \times 10^{-27}$ kg, and $1\,\text{u} \cdot c^2 = 931.5$ MeV.

<details>
<summary>Example: Binding Energy of Helium-4</summary>
<p>

Calculate the binding energy of $\prescript{4}{}{2}\text{He}$. Given: $m(\prescript{4}{}{2}\text{He}) = 4.00260$ u, $m_p = 1.00728$ u, $m_n = 1.00867$ u.

**Answer.** $\Delta m = 2(1.00728) + 2(1.00867) - 4.00260 = 2.01456 + 2.01734 - 4.00260 = 0.03030$ u.
...
- **Iron-56** ($\prescript{56}{}{26}\text{Fe}$): the peak of the curve at $\sim 8.8$ MeV/nucleon. Iron-56 is the most stable nucleus.
...
:::info Board Note
AQA and Edexcel focus on the qualitative aspects of fission and fusion. CIE may require calculation of energy released from mass defect.
:::
...
Calculate the mass defect of $\prescript{56}{}{26}\text{Fe}$. Given: $m(\prescript{56}{}{26}\text{Fe}) = 55.93493$ u, $m_p = 1.00728$ u, $m_n = 1.00867$ u.

**Answer.** $\Delta m = 26(1.00728) + 30(1.00867) - 55.93493 = 26.18928 + 30.26010 - 55.93493 = 0.51445$ u.

$E_b = 0.51445 \times 931.5 = 479.2$ MeV. $E_b/A = 479.2/56 = 8.56$ MeV/nucleon.

<b>If you get this wrong, revise:</b> [Mass Defect and Binding Energy](#1-mass-defect-and-binding-energy)
...
The binding energy per nucleon of $\prescript{235}{}{92}\text{U}$ is 7.59 MeV. When it undergoes fission into two nuclei each with binding energy per nucleon of 8.40 MeV, calculate the energy released per fission.
...
Calculate the energy released when a proton and neutron combine to form a deuteron ($\prescript{2}{}{1}\text{H}$). Given: $m_p = 1.67262 \times 10^{-27}$ kg, $m_n = 1.67493 \times 10^{-27}$ kg, $m_d = 3.34358 \times 10^{-27}$ kg, $c = 3.0 \times 10^8$ m s$^{-1}$.
...
The fusion reaction $\prescript{2}{}{1}\text{H} + \prescript{2}{}{1}\text{H} \to \prescript{3}{}{2}\text{He} + \prescript{1}{}{0}\text{n}$ releases 3.27 MeV. Given the masses: $m(\prescript{2}{}{1}\text{H}) = 2.01410$ u, $m(\prescript{3}{}{2}\text{He}) = 3.01603$ u, $m_n = 1.00867$ u. Verify the energy release using the mass defect.
