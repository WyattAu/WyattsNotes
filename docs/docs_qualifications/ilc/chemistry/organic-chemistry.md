...
Carbon forms four covalent bonds and can catenate (form chains with itself), leading to an enormous
...
| --CO--             | Ketone          | $\mathrm{CH}_3\text{COCH}_3$  |
| --COOH             | Carboxylic acid | $\mathrm{CH}_3\text{COOH}$    |
| --COO--            | Ester           | $\mathrm{CH}_3\text{COOCH}_3$ |
| --COX (X = Cl, Br) | Acyl halide     | $\mathrm{CH}_3\text{COCl}$    |
| --NH$_2$           | Amine           | $\mathrm{CH}_3\mathrm{NH}_2$    |
| --CO--NH--         | Amide           | $\mathrm{CH}_3\text{CONH}_2$  |

### IUPAC Nomenclature (OL/HL)

**Rules:**

1. Find the longest carbon chain containing the highest order functional group.
...
$$
\mathrm{CH}_4 + \mathrm{Cl}_2 \xrightarrow{\text{UV light}} \mathrm{CH}_3\mathrm{Cl} + \mathrm{HCl}
$$
...
$$
\mathrm{CH}_2=\mathrm{CH}_2 + \mathrm{H}_2 \xrightarrow{\text{Ni catalyst}} \mathrm{CH}_3\mathrm{CH}_3
$$

**Addition of halogens:**

$$
\mathrm{CH}_2=\mathrm{CH}_2 + \mathrm{Br}_2 \to \mathrm{CH}_2\text{BrCH}_2\mathrm{Br}
$$
...
$$
n\mathrm{CH}_2=\mathrm{CH}_2 \to \text{--(CH}_2\mathrm{CH}_2\text{)--}_n
$$
...
$$
\mathrm{CH}_3\mathrm{CH}^+\mathrm{CH}_3 + \mathrm{Br}^- \to \mathrm{CH}_3\text{CHBrCH}_3
$$
...
$$
\mathrm{CH}_3\text{CH(OH)CH}_3 \xrightarrow{[O]} \mathrm{CH}_3\text{COCH}_3
$$
...
$$
\mathrm{CH}_3\mathrm{CH}_2\mathrm{OH} \xrightarrow{\text{conc. } \mathrm{H}_2\mathrm{SO}_4, 170°\mathrm{C}} \mathrm{CH}_2=\mathrm{CH}_2 + \mathrm{H}_2\mathrm{O}
$$
...
Aldehydes are easily oxidised (Tollens' reagent, Fehling's solution). Ketones are not.
...
$$
\mathrm{CH}_3\mathrm{CHO} + \mathrm{CN}^- \to \mathrm{CH}_3\text{CH(CN)O}^-
$$

**Step 2:** Protonation.

$$
\mathrm{CH}_3\text{CH(CN)O}^- + \mathrm{H}^+ \to \mathrm{CH}_3\text{CH(OH)CN}
$$
...
$$
\mathrm{CH}_3\text{COOH} + \text{NaOH} \to \mathrm{CH}_3\text{COONa} + \mathrm{H}_2\mathrm{O}
$$
...
A chiral carbon has four different substituents. Optical isomers are non-superimposable mirror
images.
...
**Example (HL):** Butan-2-ol ($\mathrm{CH}_3\text{CH(OH)CH}_2\mathrm{CH}_3$) has a chiral carbon (carbon
...
1. Name the following: $\mathrm{CH}_3\mathrm{CH}_2\mathrm{CH}_2\mathrm{OH}$, $\mathrm{CH}_3\text{COOH}$,
...
**Worked Example 8 (HL):** Name $\mathrm{CH}_3\text{COCH}_3$ and $\mathrm{CH}_3\mathrm{CHO}$.

$\mathrm{CH}_3\text{COCH}_3$: 3 carbons, carbonyl at C-2. Name: propan-2-one (or acetone).
...
| Secondary | $\mathrm{R}_2$-$\text{CHOH}$ | Propan-2-ol          |
| Tertiary  | $\mathrm{R}_3$-$\mathrm{COH}$  | 2-methylpropan-2-ol  |

### Oxidation: Detailed Conditions

**Worked Example 9 (HL):** A student has propan-1-ol and propan-2-ol. Describe how to distinguish
between them using acidified potassium dichromate.

**Test with distillation (gentle heating):**

Propan-1-ol $\to$ propanal (aldehyde). The dichromate changes from orange to green.

$$\mathrm{CH}_3\mathrm{CH}_2\mathrm{CH}_2\mathrm{OH} \xrightarrow{[O], \text{distill}} \mathrm{CH}_3\mathrm{CH}_2\mathrm{CHO}$$
...
$$\mathrm{CH}_3\text{CH(OH)CH}_2\mathrm{CH}_3 \to \mathrm{CH}_3\mathrm{CH}=\text{CHCH}_3 \text{ (but-2-ene, major)}$$
...
$$\mathrm{CH}_3\mathrm{CHO} + \mathrm{CN}^- \to \mathrm{CH}_3\text{CH(OH)CN}$$

**Step 2:** Protonation of the alkoxide intermediate.

$$\mathrm{CH}_3\text{CH(OH)CN} + \mathrm{H}^+ \to \mathrm{CH}_3\text{CH(OH)CN}$$
...
2,4-dinitrophenylhydrazine (2,4-DNP) reacts with both aldehydes and ketones to form orange
precipitates (2,4-dNP derivatives). The melting point of the derivative can be used to identify the
...
| --------------------------------- | ----------------------------------------------------- | -------------- |
| $\text{NaOH}$                     | Carboxylate salt + water                              | Neutralisation |
...
| $\text{LiAlH}_4$                  | Primary alcohol                                       | Reduction      |
...
**Example:** $\mathrm{CH}_3\text{COOCH}_2\mathrm{CH}_3$ is ethyl ethanoate (ethyl from ethanol,
ethanoate from ethanoic acid).

### Physical Properties

Esters are volatile liquids with characteristic fruity odours. They have lower boiling points than
carboxylic acids of similar molecular mass because they cannot form hydrogen bonds with each other.

### Hydrolysis

**Acid hydrolysis:** Ester + water $\rightleftharpoons$ acid + alcohol (reversible, catalysed by
acid).
...
2. Butan-2-ol ($\mathrm{CH}_3\text{CH(OH)CH}_2\mathrm{CH}_3$)
3. 2-methylpropan-1-ol ($(\mathrm{CH}_3)_2\text{CHCH}_2\mathrm{OH}$)
...
Butan-2-ol ($\mathrm{CH}_3\text{CH(OH)CH}_2\mathrm{CH}_3$): Carbon-2 has four different groups
...
$$\mathrm{CH}_2\mathrm{Cl}_2 + \mathrm{Cl}_2 \to \text{CHCl}_3 + \mathrm{HCl}$$
$$\text{CHCl}_3 + \mathrm{Cl}_2 \to \mathrm{CCl}_4 + \mathrm{HCl}$$
...
| Alcohol                   | $\text{conc. H}_2\mathrm{SO}_4$, heat | Alkene                | Dehydration            |
| Carboxylic acid + alcohol | $\text{conc. H}_2\mathrm{SO}_4$       | Ester + water         | Esterification         |
...
6. Name the following compounds: (a) $\mathrm{CH}_3\mathrm{CH}_2\mathrm{CH}_2\mathrm{OH}$, (b)
   $\mathrm{CH}_3\text{COOH}$, (c) $\mathrm{CH}_3\text{COCH}_3$.
...
Formed by joining monomers without eliminating any molecule. The repeating unit is the same as the
monomer (with the double bond opened).
...
$$n\mathrm{CH}_2=\text{CHCl} \to -(\mathrm{CH}_2-\text{CHCl})-_n$$
...
- **PHB (polyhydroxybutyrate):** Produced by bacteria. Naturally biodegradable.
