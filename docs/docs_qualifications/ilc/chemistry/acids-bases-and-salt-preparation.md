...
- **Acid:** produces $\mathrm{H}^+$ (or $\mathrm{H}_3\mathrm{O}^+$) in water.
...
- $\mathrm{H}_2\mathrm{O}$ and $\mathrm{H}_3\mathrm{O}^+$ form a conjugate pair.
...
$\mathrm{NH}_3/\mathrm{NH}_4^+$ and $\mathrm{H}_2\mathrm{O}/\mathrm{OH}^-$.
...
Completely dissociate in water: $\mathrm{HCl}$, $\mathrm{HNO}_3$, $\mathrm{H}_2\mathrm{SO}_4$ (first
dissociation).
...
Partially dissociate in water: $\mathrm{CH}_3\text{COOH}$, $\mathrm{HF}$, $\mathrm{H}_2\mathrm{CO}_3$.

$$
\mathrm{CH}_3\text{COOH} + \mathrm{H}_2\mathrm{O} \rightleftharpoons \mathrm{H}_3\mathrm{O}^+ + \mathrm{CH}_3\mathrm{COO}^-
$$

### Strong Bases

Completely dissociate: $\text{NaOH}$, $\mathrm{KOH}$, $\text{Ca(OH)}_2$.

### Weak Bases

Partially dissociate: $\mathrm{NH}_3$.
...
At $25°$C: $[\mathrm{H}_3\mathrm{O}^+][\mathrm{OH}^-] = 10^{-14}$.
...
**Example (OL):** Find the pH of a $0.01\text{ M}$ solution of $\mathrm{HCl}$.

$$
[\mathrm{H}_3\mathrm{O}^+] = 0.01 = 10^{-2}\text{ M} \implies \mathrm{pH} = 2
$$

**Example (HL):** Find the pH of a $0.10\text{ M}$ solution of $\mathrm{CH}_3\text{COOH}$
($K_a = 1.8 \times 10^{-5}$).

$$
K_a = \frac{[\mathrm{H}_3\mathrm{O}^+][\mathrm{CH}_3\mathrm{COO}^-]}{[\mathrm{CH}_3\text{COOH}]} = \frac{x^2}{0.10 - x} \approx \frac{x^2}{0.10}
$$
...
**Relationship:** $\mathrm{pH} + \mathrm{pOH} = 14$ at $25°$C.
...
For $\mathrm{H}_2\mathrm{SO}_4$ (first dissociation complete):

$$
[\mathrm{H}_3\mathrm{O}^+] = 2c \quad (\text{if both protons dissociate fully})
$$
...
**Example (HL):** 25 mL of $0.10\text{ M}$ $\mathrm{HCl}$ is diluted to 250 mL. Find the new pH.
...
**Example (HL):** A buffer contains $0.10\text{ M}$ $\mathrm{CH}_3\text{COOH}$ and $0.15\text{ M}$
$\mathrm{CH}_3\text{COONa}$. Find the pH. ($\mathrm{p}K_a = 4.76$)
...
$$
\mathrm{CH}_3\mathrm{COO}^- + \mathrm{H}_3\mathrm{O}^+ \to \mathrm{CH}_3\text{COOH} + \mathrm{H}_2\mathrm{O}
$$

When base ($\mathrm{OH}^-$) is added: the weak acid reacts with $\mathrm{OH}^-$, neutralising it.

$$
\mathrm{CH}_3\text{COOH} + \mathrm{OH}^- \to \mathrm{CH}_3\mathrm{COO}^- + \mathrm{H}_2\mathrm{O}
$$
...
$$
\mathrm{Zn} + \mathrm{H}_2\mathrm{SO}_4 \to \text{ZnSO}_4 + \mathrm{H}_2
$$
...
$$
\mathrm{HCl} + \text{CaCO}_3 \to \text{CaCl}_2 + \mathrm{H}_2\mathrm{O} + \mathrm{CO}_2
$$
...
1. Calculate the pH of a $0.15\text{ M}$ solution of $\mathrm{HF}$ ($K_a = 6.8 \times 10^{-4}$).
2. Calculate the pH of a buffer containing $0.20\text{ M}$ $\mathrm{NH}_3$ and $0.25\text{ M}$
   $\mathrm{NH}_4\mathrm{Cl}$ ($K_b = 1.8 \times 10^{-5}$).
3. Explain why the pH of a $0.01\text{ M}$ solution of $\mathrm{HCl}$ is 2 but the pH of a
   $0.01\text{ M}$ solution of $\mathrm{CH}_3\text{COOH}$ is greater than 2.
4. 50 mL of $0.10\text{ M}$ $\text{NaOH}$ is added to 50 mL of $0.10\text{ M}$
   $\mathrm{CH}_3\text{COOH}$. Calculate the pH of the resulting solution.
...
**Worked Example 5 (HL):** Find the pH of a $0.0025 \text{ M}$ solution of $\mathrm{HNO}_3$.
...
**Worked Example 6 (HL):** Find the pH of $0.010 \text{ M}$ $\mathrm{H}_2\mathrm{SO}_4$, accounting for
both protons.

First proton: $[\mathrm{H}^+] = 0.010 \text{ M}$ (complete dissociation).

Second proton: $\mathrm{HSO}_4^- \rightleftharpoons \mathrm{H}^+ + \mathrm{SO}_4^{2-}$

$$K_{a2} = \frac{[\mathrm{H}^+][\mathrm{SO}_4^{2-}]}{[\mathrm{HSO}_4^-]} = 1.2 \times 10^{-2}$$
...
$$[\mathrm{H}^+]_{\text{total}} = 0.010 + 0.0046 = 0.0146 \text{ M}$$

$$\mathrm{pH} = -\log(0.0146) = 1.84$$

### Dilution Calculations

**Worked Example 7 (HL):** 25 mL of $0.10 \text{ M}$ $\mathrm{HCl}$ is diluted to 250 mL. Find the new
pH.
...
**Worked Example 9 (HL):** Calculate the pH of a $0.15 \text{ M}$ solution of $\mathrm{HF}$
...
**Worked Example 10 (HL):** Calculate the pH of a buffer containing $0.20 \text{ M}$ $\mathrm{NH}_3$
and $0.25 \text{ M}$ $\mathrm{NH}_4\mathrm{Cl}$ ($K_b = 1.8 \times 10^{-5}$).
...
$$\mathrm{pH} = pK_a + \log\frac{[\mathrm{NH}_3]}{[\mathrm{NH}_4^+]} = 9.26 + \log\frac{0.20}{0.25} = 9.26 - 0.10 = 9.16$$
...
$\mathrm{CO}_3^{2-}$ is the conjugate base of the weak acid $\mathrm{HCO}_3^-$. In water:
...
$0.10 \text{ M}$ $\mathrm{CH}_3\text{COOH}$. Calculate the pH of the resulting solution.

At the equivalence point, all $\mathrm{CH}_3\text{COOH}$ is converted to $\mathrm{CH}_3\mathrm{COO}^-$.

$$n(\mathrm{CH}_3\mathrm{COO}^-) = 0.10 \times 0.050 = 0.0050 \text{ mol}$$

$$[\mathrm{CH}_3\mathrm{COO}^-] = \frac{0.0050}{0.100} = 0.050 \text{ M}$$

$$K_b = \frac{K_w}{K_a} = \frac{1.0 \times 10^{-14}}{1.8 \times 10^{-5}} = 5.56 \times 10^{-10}$$

$$[\mathrm{OH}^-] = \sqrt{5.56 \times 10^{-10} \times 0.050} = 5.27 \times 10^{-6} \text{ M}$$
...
7. Calculate the pH of a $0.25 \text{ M}$ solution of $\mathrm{CH}_3\text{COOH}$
...
10. Sketch the pH titration curve for $25 \text{ mL}$ of $0.10 \text{ M}$ $\mathrm{NH}_3$ titrated
    with $0.10 \text{ M}$ $\mathrm{HCl}$. Label the equivalence point, buffer region, and the
...
13. A student prepares a buffer by mixing $100 \text{ mL}$ of $0.20 \text{ M}$
    $\mathrm{CH}_3\text{COOH}$ with $50 \text{ mL}$ of $0.20 \text{ M}$ $\text{NaOH}$. Calculate the
...
**Lewis acid:** $\mathrm{BF}_3$ (boron has an empty $p$ orbital), $\text{AlCl}_3$, $\mathrm{H}^+$ (has
...
1. Titrate $\text{NaOH}$ with $\mathrm{HCl}$ using phenolphthalein to find the exact volume needed.
...
Add excess $\text{CaCO}_3$ to $\mathrm{HCl}$, filter, evaporate, crystallise.
...
$$\mathrm{CuO} + \mathrm{H}_2\mathrm{SO}_4 \to \text{CuSO}_4 + \mathrm{H}_2\mathrm{O}$$

Warm $\mathrm{CuO}$ with dilute $\mathrm{H}_2\mathrm{SO}_4$, filter, evaporate, crystallise.

### Method 5: Precipitation

**Suitable for:** Insoluble salts.

**Example:** Preparation of $\mathrm{PbI}_2$:

$$\text{Pb(NO}_3)_2 + 2\mathrm{KI} \to \mathrm{PbI}_2\text{(s)} + 2\mathrm{KNO}_3$$
...
$\mathrm{CH}_3\text{COOH}$ (weak) has $[\mathrm{H}^+] \approx 0.0013$ M, pH = 2.9.
...
21. Calculate the pH at the half-equivalence point when $25 \text{ mL}$ of $0.10 \text{ M}$
    $\mathrm{CH}_3\text{COOH}$ is titrated with $\text{NaOH}$.
...
23. Explain, with equations, how a buffer containing $\mathrm{CH}_3\text{COOH}$ and
    $\mathrm{CH}_3\text{COONa}$ resists pH change when (a) a small amount of $\mathrm{HCl}$ is added,
...
### Carbonic Acid ($\mathrm{H}_2\mathrm{CO}_3$)
...
$$\mathrm{H}_2\mathrm{CO}_3 \rightleftharpoons \mathrm{H}^+ + \mathrm{HCO}_3^- \quad pK_{a1} = 6.37$$

Although the blood pH of 7.4 is outside the optimal range ($pK_a \pm 1 = 5.37$ to $7.37$), the
system works because:

1. The body constantly removes $\mathrm{CO}_2$ through respiration
...
Rain with pH less than 5.6 (normal rain is slightly acidic due to dissolved $\mathrm{CO}_2$).

**Causes:** $\mathrm{SO}_2$ and $\mathrm{NO}_x$ from fossil fuel combustion react with atmospheric
water:

$$\mathrm{SO}_2 + \mathrm{H}_2\mathrm{O} \to \mathrm{H}_2\mathrm{SO}_3$$

$$2\mathrm{SO}_2 + \mathrm{O}_2 \to 2\mathrm{SO}_3 \quad \text{then} \quad \mathrm{SO}_3 + \mathrm{H}_2\mathrm{O} \to \mathrm{H}_2\mathrm{SO}_4$$
...
$$\text{CaCO}_3 + 2\mathrm{H}^+ \to \mathrm{Ca}^{2+} + \mathrm{H}_2\mathrm{O} + \mathrm{CO}_2$$
