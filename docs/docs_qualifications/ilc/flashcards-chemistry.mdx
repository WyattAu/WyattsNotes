...
<FlashcardDeck
  ...
  cards={[
    ...
    },
    {
      ...
      front:
        'Describe the collision theory of chemical kinetics. What factors affect reaction rate?',
    ...
    },
    {
      ...
      front:
        'Describe how to perform a titration to determine the concentration of an unknown acid.',
