...
4. A transformer has 500 primary turns and 50 secondary turns. The primary voltage is
   $230\mathrm{ V_{\mathrm{rms}$. Find the secondary voltage. If the secondary current is 10 A,
...
$230\mathrm{ V_{\mathrm{rms}$ and the secondary current is $5\mathrm{ A$ at
