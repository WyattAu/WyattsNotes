...
Water potential ($\psi$) is measured in kilopascals (kPa). Pure water has $\psi = 0\text{ kPa}$.

- Solutions have negative water potential.
- Water moves from high (less negative) to low (more negative) water potential.

**Example (HL):** A cell with $\psi_{\text{cell}} = -500\text{ kPa}$ is placed in a solution with
$\psi_{\text{solution}} = -300\text{ kPa}$. Water enters the cell (moves from -300 to -500).

**Worked Example: Predicting osmosis in plant cells.**

A plant cell with $\psi_{\text{cell}} = -700$ kPa is placed in three different solutions:

(a) $\psi_{\text{solution}} = -200$ kPa (hypotonic): Water enters. The cell becomes turgid. The cell
wall prevents bursting by exerting inward pressure (turgor pressure) that opposes further water
entry.

(b) $\psi_{\text{solution}} = -700$ kPa (isotonic): No net water movement. The cell is in
equilibrium with the solution.

(c) $\psi_{\text{solution}} = -1000$ kPa (hypertonic): Water leaves the cell. The cell membrane
...
1. **Prokaryote vs eukaryote** -- know the differences clearly.
...
to the centromeres. This is the stage where chromosomes are most easily counted.
...
significantly higher than would occur naturally, resulting in faster growth and higher yields.
