...
- This limits the number of trophic levels in a food chain (typically 4-5).
...
Place a quadrat (usually $1\text{ m} \times 1\text{ m}$) randomly and count organisms. Repeat and
...
mates). Intraspecific competition (between individuals of the same species) is typically more
...
1. **Quadrat sampling:** Used for plants or slow-moving animals. A quadrat (a known area frame) is
   ...
   $$\text{Estimated population} = \frac{\text{Mean number per quadrat}}{\text{Area of quadrat}} \times \text{Total area}$$
