...
date: 2026-05-31
description:
  'Interactive flashcard deck for SAT Math revision. Spaced repetition
  covering algebra, geometry, statistics, advanced topics, and problem-solving strategies.'
tags:
  - sat
  - maths
categories:
...
<FlashcardDeck
  ...
  cards={[
    ...
    },
    {
      ...
      back: 'Difference of squares: x² − 9 = (x + 3)(x − 3). In general, a² − b² = (a + b)(a − b).',
      tags: ['algebra'],
      difficulty: 'easy',
    },
    {
    ...
    },
    {
      ...
      back: 'Eliminate obviously wrong answers first. Use units/dimensions to check. Estimate approximate answers. If stuck between two, check edge cases or substitute values from answer choices.',
      tags: ['strategy'],
      difficulty: 'medium',
    },
  ]}
