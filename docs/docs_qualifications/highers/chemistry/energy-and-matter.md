...
$\mathrm{C{} + \mathrm{O{}_2 \to \mathrm{CO{}_2$ and
$2\mathrm{S{} + 2\mathrm{O{}_2 \to 2\mathrm{SO{}_2$Then
...
**Worked Example 7:** For $\mathrm{H{}_2 + \mathrm{I{}_2 \rightleftharpoons 2\mathrm{HI{}$At
equilibrium The concentrations are $[\mathrm{H{}_2] = 0.22$$[\mathrm{I{}_2] = 0.22$
...
**Worked Example 8:** $2.0 \mathrm{ mol{}$ of $\mathrm{SO{}_2$ and $1.0 \mathrm{ mol{}$ of
$\mathrm{O{}_2$ are Placed in a $1.0 \mathrm{ L{}$ flask at equilibrium. If $1.4 \mathrm{ mol{}$ of
$\mathrm{SO{}_3$ forms, find $K_c$ for
$\mathrm{2SO{}_2 + \mathrm{O{}_2 \rightleftharpoons 2\mathrm{SO{}_3$.
...
**Worked Example 9:** $1.0 \mathrm{ mol{}$ of $\mathrm{PCl{}_5$ is placed in a $5.0 \mathrm{ L{}$
...
$\mathrm{H{}_2$ onto its surface. The bonds in $\mathrm{N{}_2$ are weakened, allowing hydrogen atoms
...
5. $1.0 \mathrm{ mol{}$ of $\mathrm{PCl{}_5$ is placed in a $5.0 \mathrm{ L{}$ container. At
...
$\mathrm{2NO{}_2 + \mathrm{F{}_2 \to 2\mathrm{NO{}_2\mathrm{F{}$The Proposed mechanism is:
...
This is first order with respect to $\mathrm{NO{}_2$ and first order with respect to
$\mathrm{F{}_2$Even Though the overall balanced equation has coefficient 2 for $\mathrm{NO{}_2$.
...
13. Using Hess's Law, calculate $\Delta H_r^\circ$ for:
    $\mathrm{3C(s){} + 4\mathrm{H{}_2\mathrm{(g){} \to \mathrm{C{}_3\mathrm{H{}_8\mathrm{(g){}$
    given $\Delta H_c^\circ(\mathrm{C{}_3\mathrm{H{}_8) = -2220 \mathrm{ kJ/mol{}$
...
16. In a bomb calorimeter, $1.00 \mathrm{ g{}$ of glucose
    ($\mathrm{C{}_6\mathrm{H{}_{12}\mathrm{O{}_6$) is burned. The temperature of $500 \mathrm{ g{}$
