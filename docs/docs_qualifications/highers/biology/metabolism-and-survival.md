...
Glucose ($\mathrm{C}_6\mathrm{H}_{12}\mathrm{O}_6$) is broken down to two molecules of pyruvate
($\mathrm{C}_3\mathrm{H}_4\mathrm{O}_3$).
...
$$\text{Pyruvate} + \mathrm{NAD}^+ + \mathrm{CoA} \to \text{Acetyl-CoA} + \mathrm{CO}_2 + \text{NADH}$$
...
- 3 turns of the cycle fix 3 $\mathrm{CO}_2$ to produce 1 TP (G3P)
- 6 turns fix 6 $\mathrm{CO}_2$ to produce 1 glucose molecule
...
| Electron acceptor    | $\mathrm{O}_2$                                                                               | $\text{NADP}^+$                                                                            |
...
$$\text{Glucose} \to 2 \text{pyruvate} \to 2 \text{lactate} + 2 \mathrm{ATP}$$
...
$$\text{Glucose} \to 2 \text{pyruvate} \to 2 \text{ethanol} + 2 \mathrm{CO}_2 + 2 \mathrm{ATP}$$
