...
To fix 6 $\mathrm{CO_2$ molecules (to make one glucose), the light reactions must produce 18 ATP
and 12 NADPH.
...
Is transported to bundle-sheath cells, where $\mathrm{CO_2$ is released and enters the Calvin
cycle. PEP carboxylase has a much higher affinity for $\mathrm{CO_2$ than RuBisCO and does not
bind $\mathrm{O_2$Minimising photorespiration.
...
Approximately 250 g of water per gram of $\mathrm{CO_2$ fixed. A CAM plant loses approximately 50
g Of water per gram of $\mathrm{CO_2$ fixed.
...
fermentation Is exploited in brewing (beer) and baking (bread -- $\mathrm{CO_2$ causes the dough
to rise).
...
- **Brewing:** Yeast ferment sugars in malted barley to produce ethanol. The $\mathrm{CO_2$
...
- Aerobic respiration yields approximately 30-32 ATP per glucose; anaerobic respiration yields only
  2 ATP per glucose.
- Aerobic respiration completely oxidises glucose to $\mathrm{CO_2$ and
  $\mathrm{H_2\mathrm{O$; anaerobic respiration produces partially oxidised products (lactate or
  ethanol).
