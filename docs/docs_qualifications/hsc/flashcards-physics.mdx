...
description: "20 interactive flashcards for NSW HSC Physics covering kinematics, forces, waves, electromagnetism, special relativity, quantum physics, orbital mechanics, and nuclear physics."
tags:
  - hsc
  - physics
  - Flashcards
...
<FlashcardDeck
  ...
  cards={[
    ...
    {
      id: 'hsc-physics-005',
      front: 'Describe circular motion. Define centripetal force, period, and frequency. Give the equations.',
    ...
    {
      id: 'hsc-physics-007',
      front: 'State the wave equation, describe superposition, and distinguish constructive from destructive interference.',
    ...
    {
      id: 'hsc-physics-009',
      front: 'State the key postulates of special relativity. Derive time dilation and length contraction.',
    ...
    {
      id: 'hsc-physics-011',
      front: 'Describe the quantum mechanical model of the atom and the Heisenberg uncertainty principle.',
    ...
    {
      id: 'hsc-physics-014',
      front: 'Describe gravitational fields: weight, gravitational acceleration g, and orbital velocity.',
    ...
    {
      id: 'hsc-physics-017',
      front: 'Describe ideal transformers. State the transformer equation and the conditions for ideality.',
    ...
    {
      id: 'hsc-physics-018',
      front: 'Describe AC circuits. Define RMS voltage and current. How are they related to peak values?',
    ...
    {
      id: 'hsc-physics-020',
      front: 'State the mass-energy equivalence equation and calculate the energy released in a nuclear reaction.',
