...
**Derivation:** Each current element $I\, dl$ produces $dB = \frac{\mu_0}{4\pi}\frac{I\, dl}{r^2}\sin 90°$.
...
A long cylindrical conductor of radius $R$ carries current $I$ with current density
$J(r) = J_0 r/R$ for $0 \le r \le R$. Find $B$ inside and outside.
