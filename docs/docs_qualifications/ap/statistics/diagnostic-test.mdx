...
description:
  'AP Statistics diagnostic test covering exploring data, probability, sampling, inference, and
  regression for exam preparation.'
tags:
  - ap
  - ap-statistics
---
...
export const questions = [
  ...
  },
  {
    ...
    options: ['Simple random sampling', 'Stratified sampling', 'Systematic sampling', 'Cluster sampling'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    difficulty: 1,
    question:
      'If P(A) = 0.3 and P(B | A) = 0.6, what is P(A and B)?',
  ...
  },
  {
    ...
    difficulty: 2,
    question:
      'The residual for a data point is calculated as:',
    options: [
...
<DiagnosticTest subject="AP Statistics" questions={questions} onComplete={handleComplete} />
...
| ----------------------- | --------- | -------------------------------------------------------------------------- |
| Exploring Data          | 4         | [Exploring Data](/docs/qualifications/ap/statistics/1-exploring-data/)     |
| Sampling and Experiment | 4         | [Sampling](/docs/qualifications/ap/statistics/2-sampling-experimentation/) |
| Probability             | 4         | [Probability](/docs/qualifications/ap/statistics/3-probability/)           |
| Statistical Inference   | 4         | [Inference](/docs/qualifications/ap/statistics/4-statistical-inference/)   |
| Regression Analysis     | 4         | [Regression](/docs/qualifications/ap/statistics/5-regression/)             |
