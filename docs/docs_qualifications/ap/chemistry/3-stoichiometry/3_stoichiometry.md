...
Partial pressure of $\mathrm{O_2$:
$P_{\mathrm{O_2} = P_{\mathrm{total} - P_{\mathrm{H_2\mathrm{O} = 760 - 23.8 = 736.2 \mathrm{ mmHg = 0.969 \mathrm{ atm$.
...
Empirical formula: $\mathrm{CH_2\mathrm{O$ (empirical mass =
