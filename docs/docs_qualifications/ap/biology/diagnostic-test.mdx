...
<DiagnosticTest subject="AP Biology" questions={questions} onComplete={handleComplete} />
...
| ------------------- | --------- | --------------------------------------------------------------------------------------------- |
| Chemistry of Life   | 4         | [Chemistry of Life](/docs/qualifications/ap/biology/1-chemistry-of-life/)                     |
| Cell Structure      | 4         | [Cell Structure and Function](/docs/qualifications/ap/biology/2-cell-structure-and-function/) |
| Cellular Energetics | 4         | [Cellular Energetics](/docs/qualifications/ap/biology/3-cellular-energetics/)                 |
| Heredity            | 4         | [Heredity](/docs/qualifications/ap/biology/4-heredity/)                                       |
| Natural Selection   | 4         | [Natural Selection](/docs/qualifications/ap/biology/5-natural-selection/)                     |
