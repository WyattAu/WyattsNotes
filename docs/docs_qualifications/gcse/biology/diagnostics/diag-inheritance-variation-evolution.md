...
description: "GCSE Biology diagnostic tests for inheritance: DNA, genetics, natural selection, evolution, genetic engineering, selective breeding."
...
Genotypes: 50% Ff (free earlobes), 50% ff (attached earlobes).
Probability of free earlobes $= 50\%$.
...
(b) Cross: Ss $\times$ Ss (both carriers). Punnett square: SS (25%), Ss (50%), ss (25%).
(i) Sickle cell anaemia (ss): $25\%$.
(ii) Carrier (Ss): $50\%$.
(iii) Completely unaffected (SS): $25\%$.
