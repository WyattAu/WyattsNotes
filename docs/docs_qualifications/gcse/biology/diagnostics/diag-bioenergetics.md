...
description: "GCSE Biology diagnostic tests for bioenergetics: photosynthesis, respiration, limiting factors, metabolic rate, anaerobic respiration."
...
(i) Animal cells: glucose $\to$ lactic acid (+ ATP).
(ii) Yeast cells (fermentation): glucose $\to$ ethanol + carbon dioxide (+ ATP).
...
(b) Oxygen delivery per minute $=$ breathing rate $\times$ tidal volume.
Before: $15 \times 0.5 = 7.5$ L/min.
During race: $40 \times 2.5 = 100$ L/min.
Increase $= 100 - 7.5 = 92.5$ L/min.
