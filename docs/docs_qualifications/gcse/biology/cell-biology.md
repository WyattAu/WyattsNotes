...
thylakoids). Not all plant cells contain chloroplasts -- root cells, for example, are typically
...
**Why the size difference matters.** Prokaryotic cells are typically 1--10 micrometres in diameter,
...
cells typically take hours to divide. This rapid reproduction is why bacteria can quickly develop
...
usually cannot change back (this is called being "terminally differentiated").
...
- Embryonic stem cell research involves the destruction of embryos, typically at the blastocyst
...
- **Benign tumours:** Grow slowly, remain in one place, not usually dangerous. They are contained
...
- **Malignant tumours:** Grow rapidly, can spread to other parts of the body (metastasis),
  ...
  the primary tumour that usually kills the patient, but the secondary tumours that disrupt the
...
9. Explain why cells need to divide by mitosis rather than simply growing larger.
