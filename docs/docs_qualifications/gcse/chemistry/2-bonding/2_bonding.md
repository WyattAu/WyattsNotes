...
($\mathrm{H_2\mathrm{O$), oxygen shares electrons with two hydrogen atoms, forming two covalent
bonds.
...
A typical exam question on Bonding requires you to apply your knowledge to an unfamiliar context.
