...
| Usually gases or liquids at room temperature | Weak forces between molecules                                         |
...
**Diamond:** Each carbon atom forms four covalent bonds with four other carbon atoms in a
...
An **alloy** is a mixture of a metal with one or more other elements (usually another metal or
carbon). The different-sized atoms distort the regular lattice, preventing layers from sliding
easily. This makes alloys harder than pure metals.
...
1. Check if it contains a metal: if yes, likely metallic or ionic bonding
...
5. Explain why steel is harder than pure iron.
