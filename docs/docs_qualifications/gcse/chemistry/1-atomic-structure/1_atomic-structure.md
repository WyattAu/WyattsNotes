...
**Isotopes** are atoms of the same element (same atomic number) with different numbers of neutrons
...
Electrons occupy **shells** (energy levels) around the nucleus. The first shell can hold up to 2
Electrons, the second up to 8, and the third up to 8 (at GCSE level; in reality the third can hold
18).
...
The **group number** (for groups 1, 2, and 13--18) tells you the number of electrons in the outer
Shell.
...
Transition metals are found in the central block of the periodic table. They have the following
Properties:
...
8. Explain why Mendeleev's periodic table was more successful than Newlands' classification.
...
A typical exam question on Atomic Structure requires you to apply your knowledge to an unfamiliar
...
Multi-step problems in Atomic Structure often combine two or more concepts. Break the problem down:
