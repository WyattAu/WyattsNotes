...
drama. Characters of high status -- kings, nobles, tragic heroes -- typically speak in blank verse.
The shift from verse to prose (see below) is therefore a significant marker of tone, status, or
state of mind.

### 3.3 Prose

Approximately twenty per cent of Shakespeare's plays is written in prose. Prose is typically used
for:
...
five-act structure typically follows this pattern:
