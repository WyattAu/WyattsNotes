...
(c) Let $s$ = small boxes, $l$ = large boxes. $s + l = 20$ and $3s + 5l = 76$.
From equation 1: $s = 20 - l$. Substitute: $3(20 - l) + 5l = 76$. $60 - 3l + 5l = 76$. $2l = 16$. $l = 8$. $s = 12$.
...
(d) First company: $C_1 = 8 + d$. Second company: $C_2 = 1.5d$.
$C_1 \lt C_2$ when $8 + d \lt 1.5d$. $8 \lt 0.5d$. $d \gt 16$.
