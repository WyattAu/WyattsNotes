...
$, $\sum_◆LB◆k=1◆RB◆^◆LB◆n+1◆RB◆ k^2 = \frac◆LB◆n(n+1)(2n+1)◆RB◆◆LB◆6◆RB◆ + (n+1)^2 = \frac◆LB◆n(n+1)(2n+1) + 6(n+1)^2◆RB◆◆LB◆6◆RB◆$, $

$, $= \frac◆LB◆(n+1)(2n^2 + n + 6n + 6)◆RB◆◆LB◆6◆RB◆ = \frac◆LB◆(n+1)(n+2)(2n+3)◆RB◆◆LB◆6◆RB◆$, $
