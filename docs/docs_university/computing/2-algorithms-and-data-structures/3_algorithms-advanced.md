...
**Total cost:** $\mathrm◆LB◆cost(f) = \sum_◆LB◆(u,v) \in E◆RB◆ f(u,v) \cdot w(u,v)$.
...
**Expected cost:**
$$E[\text◆LB◆cost] = \sum_◆LB◆i=1◆RB◆^◆LB◆n◆RB◆ (d(k_i) + 1) \cdot p_i + \sum_◆LB◆j=0◆RB◆^◆LB◆n◆RB◆ (d(d_j) + 1) \cdot q_j$$
...
$$e[i, j] = \begin◆LB◆cases◆RB◆ q_◆LB◆i-1◆RB◆ & \text◆LB◆if  j = i - 1 \\ \min_◆LB◆r=i◆RB◆^◆LB◆j◆RB◆\{e[i, r-1] + e[r+1, j] + w(i, j)\} & \text◆LB◆if  i \leq j \end◆LB◆cases◆RB◆$$
...
$\mathrm◆LB◆root[i, j-1] \leq \mathrm◆LB◆root[i, j] \leq \mathrm◆LB◆root[i+1, j]$), then the DP can be
...
$$dp[S][i] = \text◆LB◆minimum cost to visit all cities in  S \text◆LB◆ starting from city 0, ending at city  i$$
...
Pattern: $P = \text◆LB◆ababaca$Text: $T = \text◆LB◆abababaca$.
...
Search in $T = \text◆LB◆abababaca$: $i=0$: $T[0]=\text◆LB◆a=P[0]$$k=1$. $i=1$: $T[1]=\text◆LB◆b=P[1]$$k=2$.
$i=2$: $T[2]=\text◆LB◆a=P[2]$$k=3$. $i=3$: $T[3]=\text◆LB◆b=P[3]$$k=4$. $i=4$: $T[4]=\text◆LB◆a=P[4]$$k=5$.
$i=5$: $T[5]=\text◆LB◆b \neq P[5]=\text◆LB◆c$. $k=\pi[4]=3$. $P[3]=\text◆LB◆b=T[5]$$k=4$. $i=6$:
$T[6]=\text◆LB◆a=P[4]$$k=5$. $i=7$: $T[7]=\text◆LB◆c=P[5]$$k=6$. $i=8$: $T[8]=\text◆LB◆a=P[6]$$k=7=m$. Match
at $8-7+1=2$.
...
$\alpha \cdot \mathrm◆LB◆OPT$. For a maximisation problem, the solution has value at least
$\mathrm◆LB◆OPT / \alpha$.
...
$\mathrm◆LB◆OPT \geq |C|$. Therefore $|S| = 2|C| \leq 2 \cdot \mathrm◆LB◆OPT$. $\blacksquare$
...
spanning tree). The doubled MST costs $2 \cdot \mathrm◆LB◆MST \leq 2 \cdot \mathrm◆LB◆OPT$. By the
triangle inequality, shortcutting does not increase the cost. Therefore the final tour costs at most
$2 \cdot \mathrm◆LB◆OPT$. $\blacksquare$
...
Furthermore, unless $\text◆LB◆P = \text◆LB◆NP$No polynomial-time algorithm can do better than
$(1 - o(1)) \ln n$.

_Proof (approximation ratio)._ Let $n_t$ be the number of uncovered elements after $t$ iterations.
In iteration $t+1$The greedy algorithm picks a set covering at least $n_t / \mathrm◆LB◆OPT$ elements
(since OPT sets cover all $n_t$ elements). So $n_◆LB◆t+1◆RB◆ \leq n_t (1 - 1/\mathrm◆LB◆OPT)$. After
$k = \mathrm◆LB◆OPT \cdot \ln n$ iterations,
$n_k \leq n(1 - 1/\mathrm◆LB◆OPT)^◆LB◆\mathrm◆LB◆OPT \cdot \ln n◆RB◆ \leq n \cdot e^◆LB◆-\ln n◆RB◆ = 1$.
$\blacksquare$

### 5.5 Inapproximability

**Theorem 5.4 (PCP Theorem).** Unless $\text◆LB◆P = \text◆LB◆NP$There is no polynomial-time algorithm that
approximates MAX-3SAT to within any constant factor better than $7/8$.

**Theorem 5.5.** Unless $\text◆LB◆P = \text◆LB◆NP$TSP (without triangle inequality) cannot be approximated
...
String: $S = \text◆LB◆aabcaab$$n = 7$.

$Z[0]$ is undefined (the entire string matches itself).

$i = 1$: $i > r = 0$. Set $l = r = 1$. Compare: $S[0] = \text◆LB◆a = S[1] = \text◆LB◆a$So $r = 2$.
$S[1] = \text◆LB◆a \neq S[2] = \text◆LB◆b$Stop. $Z[1] = r - l = 2 - 1 = 1$. Decrement $r$: $r = 1$.

$i = 2$: $i > r = 1$. Set $l = r = 2$. Compare: $S[0] = \text◆LB◆a \neq S[2] = \text◆LB◆b$Stop
immediately. $Z[2] = 0$. $r = 1$.

$i = 3$: $i > r = 1$. Set $l = r = 3$. Compare: $S[0] = \text◆LB◆a \neq S[3] = \text◆LB◆c$Stop.
$Z[3] = 0$. $r = 2$.

$i = 4$: $i > r = 2$. Set $l = r = 4$. Compare: $S[0] = \text◆LB◆a = S[4] = \text◆LB◆a$$r = 5$.
$S[1] = \text◆LB◆a = S[5] = \text◆LB◆a$$r = 6$. $S[2] = \text◆LB◆b = S[6] = \text◆LB◆b$$r = 7$. $r = n = 7$Stop.
...
$$dp[i][j] = \begin◆LB◆cases◆RB◆ 1 & \text◆LB◆if ◆LB◆◆RB◆ i = j \\ 2 + dp[i+1][j-1] & \text◆LB◆if ◆LB◆◆RB◆ S[i] = S[j] \\ \max(dp[i+1][j], dp[i][j-1]) & \text◆LB◆if ◆LB◆◆RB◆ S[i] \neq S[j] \end◆LB◆cases◆RB◆$$
