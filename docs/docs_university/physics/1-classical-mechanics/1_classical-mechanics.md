...
description:
  "University-level notes on Classical Mechanics: 1. Newtonian Mechanics Review; 1.1 Newton's Laws;
...
The effective potential is $V_◆LB◆\mathrm◆LB◆eff◆RB◆(r) = V(r) + \frac◆LB◆l^2◆RB◆◆LB◆2mr^2◆RB◆◆RB◆$Where the second term is
...
$$E = \frac◆LB◆1◆RB◆◆LB◆2◆RB◆m\dot◆LB◆r◆RB◆^2 + V_◆LB◆\mathrm◆LB◆eff◆RB◆(r)◆RB◆$$

Since $E$ and $l$ are conserved, the radial motion is completely determined by $V_◆LB◆\mathrm◆LB◆eff◆RB◆(r)◆RB◆$.

**Circular orbits** occur at radii $r_0$ where $V_◆LB◆\mathrm◆LB◆eff◆RB◆'(r_0) = 0◆RB◆$:

$$V'(r_0) - \frac◆LB◆l^2◆RB◆◆LB◆mr_0^3◆RB◆ = 0$$

The orbit is **stable** if $V_◆LB◆\mathrm◆LB◆eff◆RB◆''(r_0) \gt 0◆RB◆$ and **unstable** if
$V_◆LB◆\mathrm◆LB◆eff◆RB◆''(r_0) \lt 0◆RB◆$.

For the Kepler problem $V(r) = -k/r$:

$$V_◆LB◆\mathrm◆LB◆eff◆RB◆(r) = -\frac◆LB◆k◆RB◆◆LB◆r◆RB◆ + \frac◆LB◆l^2◆RB◆◆LB◆2mr^2◆RB◆◆RB◆$$

$$V_◆LB◆\mathrm◆LB◆eff◆RB◆'(r) = \frac◆LB◆k◆RB◆◆LB◆r^2◆RB◆ - \frac◆LB◆l^2◆RB◆◆LB◆mr^3◆RB◆ = 0 \implies r_0 = \frac◆LB◆l^2◆RB◆◆LB◆mk◆RB◆◆RB◆$$

$$V_◆LB◆\mathrm◆LB◆eff◆RB◆''(r_0) = -\frac◆LB◆2k◆RB◆◆LB◆r_0^3◆RB◆ + \frac◆LB◆3l^2◆RB◆◆LB◆mr_0^4◆RB◆ = \frac◆LB◆m^3k^2◆RB◆◆LB◆l^4◆RB◆ \gt 0◆RB◆$$
...
$$\left(\frac◆LB◆d\mathbf◆LB◆L◆RB◆◆RB◆◆LB◆dt◆RB◆\right)_◆LB◆\mathrm◆LB◆space◆RB◆ = \boldsymbol◆LB◆\tau◆RB◆◆RB◆$$

Transforming to the body frame using
$\left(\frac◆LB◆d\mathbf◆LB◆L◆RB◆◆RB◆◆LB◆dt◆RB◆\right)_◆LB◆\mathrm◆LB◆space◆RB◆ = \left(\frac◆LB◆d\mathbf◆LB◆L◆RB◆◆RB◆◆LB◆dt◆RB◆\right)_◆LB◆\mathrm◆LB◆body◆RB◆ + \boldsymbol◆LB◆\omega◆RB◆ \times \mathbf◆LB◆L◆RB◆◆RB◆◆RB◆$:
...
as $v_◆LB◆\mathrm◆LB◆rms◆RB◆ \propto A^◆LB◆n/2◆RB◆◆RB◆$. The period is
$T \propto A/v_◆LB◆\mathrm◆LB◆rms◆RB◆ \propto A^◆LB◆1-n/2◆RB◆ = A^◆LB◆-(n-2)/2◆RB◆ = A^◆LB◆-n/(n+2)◆RB◆ \cdot A^◆LB◆\cdot◆RB◆◆RB◆$.
...
$$E = \frac◆LB◆1◆RB◆◆LB◆2◆RB◆m(1+\alpha^2)\dot◆LB◆r◆RB◆^2 + V_◆LB◆\mathrm◆LB◆eff◆RB◆(r)◆RB◆$$

Where the effective potential is:

$$V_◆LB◆\mathrm◆LB◆eff◆RB◆(r) = \frac◆LB◆l^2◆RB◆◆LB◆2mr^2◆RB◆ + mg\alpha r◆RB◆$$
...
$$\Omega_◆LB◆\mathrm◆LB◆space◆RB◆ = \frac◆LB◆L◆RB◆◆LB◆I_1◆RB◆ = \frac◆LB◆\sqrt◆LB◆I_1^2(\omega_1^2 + \omega_2^2) + I_3^2\omega_3^2◆RB◆◆RB◆◆LB◆I_1◆RB◆◆RB◆$$
...
$V(r) = -k/r$ and $V(r) = \frac◆LB◆1◆RB◆◆LB◆2◆RB◆kr^2$. (Sketch the .../1-number-and-algebra/3_proof-and-logic;
...
$$V_◆LB◆\text◆LB◆eff◆RB◆(\theta) = \frac◆LB◆(p_\phi - p_\psi\cos\theta)^2◆RB◆◆LB◆2I_1\sin^2\theta◆RB◆ + \frac◆LB◆p_\psi^2◆RB◆◆LB◆2I_3◆RB◆ + Mgd\cos\theta◆RB◆$$
...
**Solution.** $T = \frac◆LB◆1◆RB◆◆LB◆2◆RB◆ml^2\dot◆LB◆\theta◆RB◆^2$, $V = -mgl\cos\theta$ (taking pivot as reference).
$L = T - V = \frac◆LB◆1◆RB◆◆LB◆2◆RB◆ml^2\dot◆LB◆\theta◆RB◆^2 + mgl\cos\theta$.

$\frac◆LB◆\partial L◆RB◆◆LB◆\partial \dot◆LB◆\theta◆RB◆◆RB◆ = ml^2\dot◆LB◆\theta◆RB◆$,
$\frac◆LB◆d◆RB◆◆LB◆dt◆RB◆\frac◆LB◆\partial L◆RB◆◆LB◆\partial \dot◆LB◆\theta◆RB◆◆RB◆ = ml^2\ddot◆LB◆\theta◆RB◆$,
$\frac◆LB◆\partial L◆RB◆◆LB◆\partial \theta◆RB◆ = -mgl\sin\theta$.

$ml^2\ddot◆LB◆\theta◆RB◆ + mgl\sin\theta = 0 \implies \ddot◆LB◆\theta◆RB◆ + \frac◆LB◆g◆RB◆◆LB◆l◆RB◆\sin\theta = 0$.

$\blacksquare$

### Example 2: Hamilton's equations

**Problem.** For a 1D harmonic oscillator ($L = \frac◆LB◆1◆RB◆◆LB◆2◆RB◆m\dot◆LB◆x◆RB◆^2 - \frac◆LB◆1◆RB◆◆LB◆2◆RB◆kx^2$), find
Hamilton's equations.

**Solution.** $p = \frac◆LB◆\partial L◆RB◆◆LB◆\partial \dot◆LB◆x◆RB◆◆RB◆ = m\dot◆LB◆x◆RB◆$, so
$H = p\dot◆LB◆x◆RB◆ - L = \frac◆LB◆p^2◆RB◆◆LB◆2m◆RB◆ + \frac◆LB◆1◆RB◆◆LB◆2◆RB◆kx^2$.

$\dot◆LB◆x◆RB◆ = \frac◆LB◆\partial H◆RB◆◆LB◆\partial p◆RB◆ = \frac◆LB◆p◆RB◆◆LB◆m◆RB◆$,
$\dot◆LB◆p◆RB◆ = -\frac◆LB◆\partial H◆RB◆◆LB◆\partial x◆RB◆ = -kx$.
...
- **Wrong Euler-Lagrange equation.**
  $\frac◆LB◆d◆RB◆◆LB◆dt◆RB◆\frac◆LB◆\partial L◆RB◆◆LB◆\partial \dot◆LB◆q◆RB◆_i◆RB◆ - \frac◆LB◆\partial L◆RB◆◆LB◆\partial q_i◆RB◆ = 0$; the
  total time derivative is applied to $\partial L/\partial \dot◆LB◆q◆RB◆_i$, not to $L$ itself. **Fix:**
  Compute $\partial L/\partial \dot◆LB◆q◆RB◆_i$ first, then take $d/dt$.
...
- Euler-Lagrange equation:
  $\frac◆LB◆d◆RB◆◆LB◆dt◆RB◆\frac◆LB◆\partial L◆RB◆◆LB◆\partial \dot◆LB◆q◆RB◆_i◆RB◆ - \frac◆LB◆\partial L◆RB◆◆LB◆\partial q_i◆RB◆ = 0$.
- Hamiltonian: $H = \sum p_i \dot◆LB◆q◆RB◆_i - L$; Hamilton's equations give $2n$ first-order ODEs.
