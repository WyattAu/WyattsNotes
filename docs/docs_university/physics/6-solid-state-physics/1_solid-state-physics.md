...
contribute to the low-temperature Specific heat of ferromagnets: $C*◆LB◆\mathrm◆LB◆mag◆RB◆ \propto T^◆LB◆3/2◆RB◆◆RB◆$.
...
**Solution.**
$◆LB◆\lambda = \frac◆LB◆hc◆RB◆◆LB◆E_g◆RB◆ = \frac◆LB◆1240 \mathrm◆LB◆ eV\cdot◆RB◆ nm◆RB◆◆RB◆◆LB◆1.1 \mathrm◆LB◆ eV◆RB◆◆RB◆ = 1127 \mathrm◆LB◆ nm◆RB◆$
(infrared).
