...
- **Sudden approximation.** If the Hamiltonian changes rapidly compared to the system's natural
  ...
  $|\psi_◆LB◆\mathrm◆LB◆after◆RB◆\rangle = |\psi_◆LB◆\mathrm◆LB◆before◆RB◆\rangle◆RB◆◆RB◆$. The probability of finding the
  system in the new $n$-th eigenstate is
  $P_n = |\langle n_◆LB◆\mathrm◆LB◆new◆RB◆|\psi_◆LB◆\mathrm◆LB◆before◆RB◆\rangle|^2◆RB◆◆RB◆$.
...
$$◆LB◆\kappa = \sqrt◆LB◆\frac◆LB◆2(9.109 \times 10^◆LB◆-31◆RB◆)(10 - 5)(1.602 \times 10^◆LB◆-19◆RB◆)◆RB◆◆LB◆(1.055 \times 10^◆LB◆-34◆RB◆)^2◆RB◆◆RB◆ = \sqrt◆LB◆1.302 \times 10^◆LB◆20◆RB◆◆RB◆ = 1.141 \times 10^◆LB◆10◆RB◆\;\mathrm◆LB◆m◆RB◆^◆LB◆-1◆RB◆◆RB◆$$
...
$$E_n = -\frac◆LB◆m_e e^4◆RB◆◆LB◆2(4\pi\varepsilon_0)^2 \hbar^2◆RB◆ \cdot \frac◆LB◆1◆RB◆◆LB◆n^2◆RB◆ = -\frac◆LB◆13.6\,\mathrm◆LB◆eV◆RB◆◆LB◆n^2◆RB◆, \quad n = 1, 2, 3, \ldots◆RB◆$$
...
$$\hat◆LB◆H◆RB◆_◆LB◆\mathrm◆LB◆sub◆RB◆ = E_n^◆LB◆(0)◆RB◆\hat◆LB◆I◆RB◆ + \lambda \hat◆LB◆W◆RB◆◆RB◆$$
...
$$E_◆LB◆\mathrm◆LB◆var◆RB◆ \approx \frac◆LB◆\hbar\omega◆RB◆◆LB◆2◆RB◆\!\left(1 + \frac◆LB◆3\lambda\hbar◆RB◆◆LB◆4m^2\omega^3◆RB◆\right)◆RB◆$$
...
$$|\psi_◆LB◆\text◆LB◆triplet◆RB◆|^2 = 0 \quad \text◆LB◆when◆RB◆  \mathbf◆LB◆r◆RB◆_1 = \mathbf◆LB◆r◆RB◆_2◆RB◆$$

$$|\psi_◆LB◆\text◆LB◆singlet◆RB◆|^2 > 0 \quad \text◆LB◆when◆RB◆  \mathbf◆LB◆r◆RB◆_1 = \mathbf◆LB◆r◆RB◆_2◆RB◆$$
...
The splitting: $E_◆LB◆\text◆LB◆singlet◆RB◆ - E_◆LB◆\text◆LB◆triplet◆RB◆ = 2K \approx 0.86◆RB◆◆RB◆$ eV. This is the exchange
splitting.
...
For any trial wavefunction $\psi_◆LB◆\text◆LB◆trial◆RB◆◆RB◆$ (normalised), the expectation value of the
Hamiltonian is an upper bound on the true ground state energy:

$$E_◆LB◆\text◆LB◆trial◆RB◆ = \langle\psi_◆LB◆\text◆LB◆trial◆RB◆|\hat◆LB◆H◆RB◆|\psi_◆LB◆\text◆LB◆trial◆RB◆\rangle \geq E_0◆RB◆◆RB◆◆RB◆$$

The equality holds if and only if $\psi_◆LB◆\text◆LB◆trial◆RB◆ = \psi_0◆RB◆$.
...
**Bonding (singlet):** $E_◆LB◆\text◆LB◆singlet◆RB◆ = 2E_◆LB◆1s◆RB◆ + \frac◆LB◆e^2◆RB◆◆LB◆R◆RB◆ + \frac◆LB◆2J + 2K◆RB◆◆LB◆1 + S^2◆RB◆◆RB◆$

**Antibonding (triplet):** $E_◆LB◆\text◆LB◆triplet◆RB◆ = 2E_◆LB◆1s◆RB◆ + \frac◆LB◆e^2◆RB◆◆LB◆R◆RB◆ + \frac◆LB◆2J - 2K◆RB◆◆LB◆1 - S^2◆RB◆◆RB◆$
...
$\psi_◆LB◆\text◆LB◆trial◆RB◆ = (Z_◆LB◆\text◆LB◆eff◆RB◆^3/\pi a_0^3)\exp(-Z_◆LB◆\text◆LB◆eff◆RB◆r_1/a_0)\exp(-Z_◆LB◆\text◆LB◆eff◆RB◆r_2/a_0)◆RB◆◆RB◆◆RB◆◆RB◆$
where $Z_◆LB◆\text◆LB◆eff◆RB◆◆RB◆$ is a variational parameter.

The energy expectation value (treating the electron-electron repulsion as a perturbation):

$$E(Z_◆LB◆\text◆LB◆eff◆RB◆) = 2\times\frac◆LB◆Z_◆LB◆\text◆LB◆eff◆RB◆^2◆RB◆◆LB◆2◆RB◆\text◆LB◆Ry◆RB◆ - 2\times\frac◆LB◆Z_◆LB◆\text◆LB◆eff◆RB◆ Z◆RB◆◆LB◆1◆RB◆\text◆LB◆Ry◆RB◆ + \frac◆LB◆5◆RB◆◆LB◆8◆RB◆Z_◆LB◆\text◆LB◆eff◆RB◆\text◆LB◆Ry◆RB◆◆RB◆◆RB◆◆RB◆◆RB◆$$

$$= \left(Z_◆LB◆\text◆LB◆eff◆RB◆^2 - 4Z_◆LB◆\text◆LB◆eff◆RB◆ + \frac◆LB◆5◆RB◆◆LB◆4◆RB◆Z_◆LB◆\text◆LB◆eff◆RB◆\right)\text◆LB◆Ry◆RB◆ = \left(Z_◆LB◆\text◆LB◆eff◆RB◆^2 - \frac◆LB◆11◆RB◆◆LB◆4◆RB◆Z_◆LB◆\text◆LB◆eff◆RB◆\right)\text◆LB◆Ry◆RB◆◆RB◆◆RB◆◆RB◆◆RB◆◆RB◆$$

Minimising:
$\partial E/\partial Z_◆LB◆\text◆LB◆eff◆RB◆ = (2Z_◆LB◆\text◆LB◆eff◆RB◆ - 11/4) = 0 \implies Z_◆LB◆\text◆LB◆eff◆RB◆ = 11/8 = 1.375◆RB◆◆RB◆◆RB◆$.
...
The effective charge $Z_◆LB◆\text◆LB◆eff◆RB◆ = 1.375 < 2◆RB◆$ reflects the screening of the nuclear charge by the
other electron: each electron partially shields the nucleus from the other, reducing the effective
charge from $Z = 2$ to $Z_◆LB◆\text◆LB◆eff◆RB◆ \approx 1.375◆RB◆$.
...
$$\sigma_◆LB◆\text◆LB◆total◆RB◆ = \frac◆LB◆4\pi◆RB◆◆LB◆k◆RB◆\,\text◆LB◆Im◆RB◆\,f(0) = \frac◆LB◆4\pi◆RB◆◆LB◆k^2◆RB◆\sum_◆LB◆l=0◆RB◆^◆LB◆\infty◆RB◆(2l+1)\sin^2\delta_l◆RB◆$$
...
$$\delta_l(E) \approx \delta_◆LB◆\text◆LB◆bg◆RB◆ + \arctan\!\left(\frac◆LB◆\Gamma/2◆RB◆◆LB◆E_R - E◆RB◆\right)◆RB◆$$
...
2. **The variational principle gives an upper bound:** $E_◆LB◆\text◆LB◆trial◆RB◆ \geq E_0◆RB◆$ always. If you
...
$Z_◆LB◆\text◆LB◆eff◆RB◆◆RB◆$ for the $1s$ electrons:

(a) Calculate $Z_◆LB◆\text◆LB◆eff◆RB◆◆RB◆$ for the $1s$ electrons, treating the $2s$ electron as a perturbation.

(b) Calculate the ionisation energy (removing the $2s$ electron) and compare with the experimental
value of 5.39 eV.

(c) Explain why the $2s$ electron is effectively screened by $Z_◆LB◆\text◆LB◆eff◆RB◆ \approx 1.26◆RB◆$.
...
partially: using the helium result, $Z_◆LB◆\text◆LB◆eff◆RB◆(1s) \approx Z - 5/16 = 3 - 0.3125 = 2.69◆RB◆$.

(b) The $2s$ electron sees an effective nuclear charge of
$Z_◆LB◆\text◆LB◆eff◆RB◆(2s) \approx 3 - 2 \times 0.85 = 1.3◆RB◆$ (Slater's rules). The energy:

$$E_◆LB◆2s◆RB◆ = -\frac◆LB◆Z_◆LB◆\text◆LB◆eff◆RB◆^2◆RB◆◆LB◆n^2◆RB◆\times 13.6\ \text◆LB◆eV◆RB◆ = -\frac◆LB◆1.3^2◆RB◆◆LB◆4◆RB◆\times 13.6 = -\frac◆LB◆1.69◆RB◆◆LB◆4◆RB◆\times 13.6 = -5.75\ \text◆LB◆eV◆RB◆◆RB◆$$
...
charge $Z_◆LB◆\text◆LB◆eff◆RB◆ \approx 1.26◆RB◆$ (using Hartree--Fock) represents this average screening.
...
$$\psi(x) \approx \frac◆LB◆C◆RB◆◆LB◆\sqrt◆LB◆p(x)◆RB◆◆RB◆\exp\!\left(\pm\frac◆LB◆i◆RB◆◆LB◆\hbar◆RB◆\int^x p(x')\,dx'\right) \quad \text◆LB◆(classically allowed,  E > V\text◆LB◆)◆RB◆◆RB◆$$

$$\psi(x) \approx \frac◆LB◆C◆RB◆◆LB◆\sqrt◆LB◆|p(x)|◆RB◆◆RB◆\exp\!\left(\pm\frac◆LB◆1◆RB◆◆LB◆\hbar◆RB◆\int^x |p(x')|\,dx'\right) \quad \text◆LB◆(classically forbidden,  E < V\text◆LB◆)◆RB◆◆RB◆$$
...
$$\frac◆LB◆\pi a◆RB◆◆LB◆\hbar c◆RB◆\sqrt◆LB◆2mc^2 V_0◆RB◆\left(1 - \frac◆LB◆E◆RB◆◆LB◆V_0◆RB◆\right) = \frac◆LB◆\pi \times 30\,\text◆LB◆fm◆RB◆◆LB◆197\,\text◆LB◆MeV◆RB◆\cdot\text◆LB◆fm◆RB◆\sqrt◆LB◆2 \times 3726 \times 25◆RB◆\times 0.8◆RB◆◆RB◆$$
...
potential $V_◆LB◆\text◆LB◆ext◆RB◆(\mathbf◆LB◆r◆RB◆)◆RB◆$ (up to an additive constant), and hence the full many-body
Hamiltonian and all ground-state properties.

**Theorem 2:** The ground-state energy is a functional of the density:
$E[n] = F_◆LB◆\text◆LB◆HK◆RB◆[n] + \int V_◆LB◆\text◆LB◆ext◆RB◆(\mathbf◆LB◆r◆RB◆)n(\mathbf◆LB◆r◆RB◆)\,d^3r◆RB◆◆RB◆$And the variational
...
$$\left[-\frac◆LB◆\hbar^2◆RB◆◆LB◆2m◆RB◆\nabla^2 + V_◆LB◆\text◆LB◆eff◆RB◆[n](\mathbf◆LB◆r◆RB◆)\right]\psi_i(\mathbf◆LB◆r◆RB◆) = \varepsilon_i\psi_i(\mathbf◆LB◆r◆RB◆)◆RB◆$$

$$n(\mathbf◆LB◆r◆RB◆) = \sum_◆LB◆i=1◆RB◆^◆LB◆N◆RB◆|\psi_i(\mathbf◆LB◆r◆RB◆)|^2 \quad \text◆LB◆(summing over occupied states)◆RB◆$$

$$V_◆LB◆\text◆LB◆eff◆RB◆ = V_◆LB◆\text◆LB◆ext◆RB◆ + V_H[n] + V_◆LB◆\text◆LB◆xc◆RB◆[n]◆RB◆◆RB◆◆RB◆$$
...
The exchange-correlation functional $V_◆LB◆\text◆LB◆xc◆RB◆[n]◆RB◆$ contains all many-body effects beyond the
...
error** is not cancelled by the local density approximation (LDA) for $V_◆LB◆\text◆LB◆xc◆RB◆◆RB◆$. Consequences:

- Wrong asymptotic behaviour: $V_◆LB◆\text◆LB◆eff◆RB◆(r \to \infty) \to -e^2/r◆RB◆$ (correct) vs.
  $V_◆LB◆\text◆LB◆eff◆RB◆ \to 0◆RB◆$ (LDA, wrong)
...
$$T_◆LB◆\text◆LB◆TF◆RB◆[n] = \frac◆LB◆3\hbar^2◆RB◆◆LB◆10m◆RB◆(3\pi^2)^◆LB◆2/3◆RB◆\int n^◆LB◆5/3◆RB◆(\mathbf◆LB◆r◆RB◆)\,d^3r = C_◆LB◆\text◆LB◆TF◆RB◆\int n^◆LB◆5/3◆RB◆\,d^3r◆RB◆◆RB◆$$

For an atom with nuclear charge $Ze$Minimising
$E[n] = T_◆LB◆\text◆LB◆TF◆RB◆[n] - Ze^2\int n(\mathbf◆LB◆r◆RB◆)/r\,d^3r + \frac◆LB◆1◆RB◆◆LB◆2◆RB◆e^2\iint n(\mathbf◆LB◆r◆RB◆)n(\mathbf◆LB◆r◆RB◆')/|\mathbf◆LB◆r◆RB◆-\mathbf◆LB◆r◆RB◆'|\,d^3rd^3r'◆RB◆$:

The variational equation gives:

$$C_◆LB◆\text◆LB◆TF◆RB◆\,n^◆LB◆2/3◆RB◆ = \frac◆LB◆Ze^2◆RB◆◆LB◆r◆RB◆ - e^2\int\frac◆LB◆n(\mathbf◆LB◆r◆RB◆')◆RB◆◆LB◆|\mathbf◆LB◆r◆RB◆-\mathbf◆LB◆r◆RB◆'|◆RB◆\,d^3r'◆RB◆$$

This integral equation can be solved by scaling: $n(r) = (Z/a_0^3)\,g(r/a_0 Z^◆LB◆-1/3◆RB◆)$ where $g$ is
a universal function.

The Thomas--Fermi energy:
$E_◆LB◆\text◆LB◆TF◆RB◆ = -\frac◆LB◆3◆RB◆◆LB◆7◆RB◆(9\pi/2)^◆LB◆2/3◆RB◆\frac◆LB◆Z^◆LB◆7/3◆RB◆e^2◆RB◆◆LB◆2a_0◆RB◆ = -20.8\,Z^◆LB◆7/3◆RB◆◆RB◆$ eV.
...
**Solution.** $\psi_n(x) = \sqrt◆LB◆\frac◆LB◆2◆RB◆◆LB◆a◆RB◆◆RB◆\sin\left(\frac◆LB◆n\pi x◆RB◆◆LB◆a◆RB◆\right)$,
$E_n = \frac◆LB◆n^2\pi^2\hbar^2◆RB◆◆LB◆2ma^2◆RB◆$, $n = 1, 2, 3, \ldots$

$\blacksquare$

### Example 2: Uncertainty principle

**Problem.** An electron is confined to a region of width $0.1 \mathrm◆LB◆ nm◆RB◆$. Estimate the minimum
uncertainty in its momentum.

**Solution.** $\Delta x = 0.1 \times 10^◆LB◆-9◆RB◆ \mathrm◆LB◆ m◆RB◆$.
$◆LB◆\Delta p \geq \frac◆LB◆\hbar◆RB◆◆LB◆2\Delta x◆RB◆ = \frac◆LB◆1.055 \times 10^◆LB◆-34◆RB◆◆RB◆◆LB◆2 \times 10^◆LB◆-10◆RB◆◆RB◆ = 5.28 \times 10^◆LB◆-25◆RB◆ \mathrm◆LB◆ kg\cdot◆RB◆ m/s◆RB◆$.
...
- **Wrong commutator interpretation.** If $[\hat◆LB◆A◆RB◆, \hat◆LB◆B◆RB◆] = 0$, the observables share
  eigenstates and can be simultaneously measured. If not, they obey the uncertainty principle.
  **Fix:** $[\hat◆LB◆x◆RB◆, \hat◆LB◆p◆RB◆] = i\hbar$ implies $\Delta x \cdot \Delta p \geq \hbar/2$.
- **Confusing time-dependent and time-independent Schrödinger equations.** Time-dependent:
  $i\hbar\frac◆LB◆\partial\psi◆RB◆◆LB◆\partial t◆RB◆ = \hat◆LB◆H◆RB◆\psi$. Time-independent: $\hat◆LB◆H◆RB◆\phi = E\phi$.
...
- Postulates: state vector $|\psi\rangle$, observables as Hermitian operators, measurement gives
  eigenvalues.
- Schrödinger equation: $i\hbar\partial\psi/\partial t = \hat◆LB◆H◆RB◆\psi$; stationary states:
  $\hat◆LB◆H◆RB◆\phi_n = E_n\phi_n$.
- Commutators and uncertainty:
  $[\hat◆LB◆A◆RB◆, \hat◆LB◆B◆RB◆] \neq 0 \Rightarrow \Delta A \cdot \Delta B \geq \frac◆LB◆1◆RB◆◆LB◆2◆RB◆|\langle[\hat◆LB◆A◆RB◆, \hat◆LB◆B◆RB◆]\rangle|$.
