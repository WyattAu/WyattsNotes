...
$$\mathbf◆LB◆E◆RB◆(\mathbf◆LB◆r◆RB◆, t) = \mathrm◆LB◆Re◆RB◆\left[\tilde◆LB◆\mathbf◆LB◆E◆RB◆◆RB◆\, e^◆LB◆i(\mathbf◆LB◆k◆RB◆\cdot\mathbf◆LB◆r◆RB◆ - \omega t)◆RB◆\right]$$
...
**Example.** A single slit of width $a$ has aperture function $t(x) = \mathrm◆LB◆rect◆RB◆(x/a)$. Its
Fourier Transform is $\mathrm◆LB◆sinc◆RB◆(\pi a \sin\theta/\lambda)$Directly giving the single-slit
...
$t(x) = \mathrm◆LB◆rect◆RB◆(x/a) * [\delta(x - 3a/2) + \delta(x + 3a/2)]$ I.e., the convolution of a
...
$E(\theta) \propto \mathrm◆LB◆sinc◆RB◆(\pi a\sin\theta/\lambda) \cdot \cos(\pi \cdot 3a \sin\theta/\lambda)$
...
$$V = \frac◆LB◆2\pi a◆RB◆◆LB◆\lambda◆RB◆\mathrm◆LB◆NA◆RB◆$$
...
$\mathrm◆LB◆NA◆RB◆ = \sqrt◆LB◆1.48^2 - 1.46^2◆RB◆ = \sqrt◆LB◆2.190 - 2.132◆RB◆ = \sqrt◆LB◆0.0588◆RB◆ = 0.242$.
...
$$I(u) = I_0\,a^2\,\mathrm◆LB◆sinc◆RB◆^2(\pi a u)\,\frac◆LB◆\sin^2(N\pi d u)◆RB◆◆LB◆\sin^2(\pi d u)◆RB◆$$
...
$$L_c = \frac◆LB◆\lambda^2◆RB◆◆LB◆\Delta\lambda◆RB◆ = \frac◆LB◆(589 \times 10^◆LB◆-9◆RB◆)^2◆RB◆◆LB◆0.6 \times 10^◆LB◆-9◆RB◆◆RB◆ = \frac◆LB◆3.47 \times 10^◆LB◆-13◆RB◆◆RB◆◆LB◆6 \times 10^◆LB◆-10◆RB◆◆RB◆ \approx 5.78 \times 10^◆LB◆-4◆RB◆\,\mathrm◆LB◆m◆RB◆ \approx 0.578\,\mathrm◆LB◆mm◆RB◆$$

For a He-Ne laser ($\lambda = 632.8$ nm, $\Delta\lambda \sim 10^◆LB◆-6◆RB◆$ nm):

$$L_c = \frac◆LB◆(632.8 \times 10^◆LB◆-9◆RB◆)^2◆RB◆◆LB◆10^◆LB◆-15◆RB◆◆RB◆ \approx 400\,\mathrm◆LB◆m◆RB◆$$
...
$$S_0 = |E_x|^2 + |E_y|^2, \quad S_1 = |E_x|^2 - |E_y|^2, \quad S_2 = 2\,\mathrm◆LB◆Re◆RB◆(E_x E_y^*), \quad S_3 = 2\,\mathrm◆LB◆Im◆RB◆(E_x E_y^*)$$
...
$$t(x) = \sum_◆LB◆n=0◆RB◆^◆LB◆N-1◆RB◆\text◆LB◆rect◆RB◆\!\left(\frac◆LB◆x - nd◆RB◆◆LB◆a◆RB◆\right)$$
...
The fundamental mode ($\text◆LB◆TEM_◆RB◆◆LB◆00◆RB◆$) of a laser cavity is a **Gaussian beam**:
...
2. **The Abbe limit is not a fundamental limit:** Techniques such as STED (stimulated emission
   ...
   microscopy) can achieve resolutions well below the Abbe limit of $\lambda/(2\text◆LB◆NA◆RB◆)$. The 2014
...
$n_o(800\,\text◆LB◆nm◆RB◆) = 1.6549$, $n_e(800\,\text◆LB◆nm◆RB◆) = 1.5425$ (at $\theta = 29.2°$)

$n_o(400\,\text◆LB◆nm◆RB◆) = 1.7030$, $n_e(400\,\text◆LB◆nm◆RB◆) = 1.5665$ (at $\theta = 29.2°$)
...
$$\hat◆LB◆\mathbf◆LB◆x◆RB◆◆RB◆ = \arg\min_◆LB◆\mathbf◆LB◆x◆RB◆◆RB◆ \|\mathbf◆LB◆x◆RB◆\|_1 \quad \text◆LB◆subject◆RB◆ to  \mathbf◆LB◆y◆RB◆ = \Phi\mathbf◆LB◆x◆RB◆$$
