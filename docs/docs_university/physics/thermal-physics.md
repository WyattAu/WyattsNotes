...
For 1 mole of each gas: $\Delta S_◆LB◆\mathrm◆LB◆mix◆RB◆ = 2R\ln 2 \approx 11.5\,\mathrm◆LB◆J◆RB◆/K$.
...
This is Poisson statistics: fluctuations scale as $1/\sqrt◆LB◆N◆RB◆$Negligible for macroscopic systems.
...
- **Assuming the classical limit always applies.** Electrons in metals are degenerate ($T \ll T_F$)
  ...
  Bose-Einstein condensation and superfluidity. The classical limit $n\lambda_◆LB◆\mathrm◆LB◆th◆RB◆^3 \ll 1$
...
| -------- | ------------------------------------ | ---------- | -------- | -------------------- |
| $\alpha$ | $C \propto \|t\|^◆LB◆-\alpha◆RB◆$          | 0 (jump)   | 0 (log)  | $\approx 0.110$      |
| $\beta$  | $\phi \propto (-t)^\beta$            | $1/2$      | $1/8$    | $\approx 0.326$      |
| $\gamma$ | $\chi \propto \|t\|^◆LB◆-\gamma◆RB◆$       | $1$        | $7/4$    | $\approx 1.237$      |
...
$$V_◆LB◆\text◆LB◆rms◆RB◆ = \sqrt◆LB◆1.66 \times 10^◆LB◆-10◆RB◆◆RB◆ \approx 1.29 \times 10^◆LB◆-5◆RB◆ \text◆LB◆ V◆RB◆ = 12.9 \text◆LB◆  \mu\text◆LB◆V◆RB◆$$
...
$$n = \frac◆LB◆8.96 \times 10^3 \text◆LB◆ kg/m◆RB◆^3◆RB◆◆LB◆63.5 \times 10^◆LB◆-3◆RB◆ \text◆LB◆ kg/mol◆RB◆ \times N_A = 1.41 \times 10^◆LB◆29◆RB◆ \text◆LB◆ m◆RB◆^◆LB◆-3◆RB◆ \times 6.022 \times 10^◆LB◆23◆RB◆ = 8.49 \times 10^◆LB◆28◆RB◆ \text◆LB◆ m◆RB◆^◆LB◆-3◆RB◆$$
...
5. **Classical vs. Quantum statistics**: At temperatures much higher than the degeneracy temperature
   ...
   the Maxwell--Boltzmann distribution. The quantum corrections are of order $n\lambda_◆LB◆\text◆LB◆dB◆RB◆^3$
   where $\lambda_◆LB◆\text◆LB◆dB◆RB◆ = h/\sqrt◆LB◆2\pi mk_BT◆RB◆$ is the thermal de Broglie wavelength.
...
- Thermodynamic laws: zeroth (thermal equilibrium), first ($\Delta U = Q - W$), second (entropy
  ...
  crystals).
- Entropy: $dS = dQ_◆LB◆\text◆LB◆rev◆RB◆◆RB◆/T$; statistical interpretation $S = k_B \ln \Omega$ (Boltzmann).
