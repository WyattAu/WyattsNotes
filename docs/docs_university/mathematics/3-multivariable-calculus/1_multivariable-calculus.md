...
$\iint_◆LB◆\mathrm◆LB◆disk◆RB◆ \mathbf◆LB◆F◆RB◆ \cdot (-\mathbf◆LB◆k◆RB◆)\, dS = \iint_◆LB◆\mathrm◆LB◆disk◆RB◆ 0\, dS = 0◆RB◆◆RB◆$.
...
- **Confusing partial and total derivatives.** Partial derivatives hold other variables constant;
  total derivatives account for all variable changes. **Fix:** $\frac◆LB◆\partial f◆RB◆◆LB◆\partial x◆RB◆$ vs
  $\frac◆LB◆df◆RB◆◆LB◆dt◆RB◆ = \frac◆LB◆\partial f◆RB◆◆LB◆\partial x◆RB◆\frac◆LB◆dx◆RB◆◆LB◆dt◆RB◆ + \frac◆LB◆\partial f◆RB◆◆LB◆\partial y◆RB◆\frac◆LB◆dy◆RB◆◆LB◆dt◆RB◆$.
...
- **Confusing the Jacobian and Hessian.** Jacobian: matrix of first partial derivatives (for
  ...
  $J_◆LB◆ij◆RB◆ = \frac◆LB◆\partial f_i◆RB◆◆LB◆\partial x_j◆RB◆$; Hessian
  $H_◆LB◆ij◆RB◆ = \frac◆LB◆\partial^2 f◆RB◆◆LB◆\partial x_i \partial x_j◆RB◆$.

## Worked Examples

### Example 1: Chain rule

**Problem.** Let $f(x, y) = x^2 y$ where $x = \cos t$, $y = \sin t$. Find $\frac◆LB◆df◆RB◆◆LB◆dt◆RB◆$ at
$t = \pi/4$.

**Solution.**
$\frac◆LB◆df◆RB◆◆LB◆dt◆RB◆ = \frac◆LB◆\partial f◆RB◆◆LB◆\partial x◆RB◆\frac◆LB◆dx◆RB◆◆LB◆dt◆RB◆ + \frac◆LB◆\partial f◆RB◆◆LB◆\partial y◆RB◆\frac◆LB◆dy◆RB◆◆LB◆dt◆RB◆ = 2xy(-\sin t) + x^2 \cos t$.

At $t = \pi/4$: $x = y = \frac◆LB◆\sqrt◆LB◆2◆RB◆◆RB◆◆LB◆2◆RB◆$.
$\frac◆LB◆df◆RB◆◆LB◆dt◆RB◆ = 2 \cdot \frac◆LB◆1◆RB◆◆LB◆2◆RB◆ \cdot (-\frac◆LB◆\sqrt◆LB◆2◆RB◆◆RB◆◆LB◆2◆RB◆) + \frac◆LB◆1◆RB◆◆LB◆2◆RB◆ \cdot \frac◆LB◆\sqrt◆LB◆2◆RB◆◆RB◆◆LB◆2◆RB◆ = -\frac◆LB◆\sqrt◆LB◆2◆RB◆◆RB◆◆LB◆2◆RB◆ + \frac◆LB◆\sqrt◆LB◆2◆RB◆◆RB◆◆LB◆4◆RB◆ = -\frac◆LB◆\sqrt◆LB◆2◆RB◆◆RB◆◆LB◆4◆RB◆$.
...
**Solution.**
$\int_0^1 \int_0^2 xy \, dy\, dx = \int_0^1 x \left[\frac◆LB◆y^2◆RB◆◆LB◆2◆RB◆\right]_0^2 dx = \int_0^1 2x \, dx = [x^2]_0^1 = 1$.
