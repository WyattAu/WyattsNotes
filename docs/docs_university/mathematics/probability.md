...
description: "University-level notes on Probability Theory: 1. Probability Spaces; 1.1 Sample Spaces and Events; 1.2 Probability Measures; 1.3 Conditional Probability and Ind"
...
*Solution.* Let $Y = X^2$ where $X \sim N(0, 1)$. For $y \geq 0$:
