...
General solution: $y = Ae^◆LB◆2x◆RB◆ + Be^◆LB◆3x◆RB◆$.
...
**Solution.** Complementary function (from above): $y_c = Ae^◆LB◆2x◆RB◆ + Be^◆LB◆3x◆RB◆$.

Particular integral: try $y_p = Ce^x$. Substituting:
$Ce^x - 5Ce^x + 6Ce^x = 2Ce^x = e^x \implies C = 1/2$.

General solution: $y = Ae^◆LB◆2x◆RB◆ + Be^◆LB◆3x◆RB◆ + \frac◆LB◆1◆RB◆◆LB◆2◆RB◆e^x$.
...
- First-order separable: $\frac◆LB◆dy◆RB◆◆LB◆dx◆RB◆ = f(x)g(y) \implies \int \frac◆LB◆dy◆RB◆◆LB◆g(y)◆RB◆ = \int f(x)\, dx$.
