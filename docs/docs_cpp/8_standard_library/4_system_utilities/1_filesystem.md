...
description: "C++: Filesystem Library — `std::filesystem::path`; Path Composition; Path Iteration; Directory Iterators with worked examples and exam-style questions."
