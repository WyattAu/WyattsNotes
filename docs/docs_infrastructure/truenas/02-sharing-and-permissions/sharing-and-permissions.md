...
description: "Sharing and Permissions — SMB/CIFS; SMB Protocol Overview; SMB Dialect Negotiation; SMB3 Features in Detail with worked examples and exam-style questions."
