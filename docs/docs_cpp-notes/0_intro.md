...
This resource is created as a tutorial and aggregation of best practices in C++. Code examples are written in godbolt and embedded to this website, this provide clarity and a intractable environment. An example as follows:
