...
$$
\mathrm◆LB◆If ◆LB◆◆RB◆ N \in \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆ \mathrm◆LB◆ with ◆LB◆◆RB◆ \mu(N) = 0 \mathrm◆LB◆ and ◆LB◆◆RB◆ A \subseteq N, \mathrm◆LB◆ then ◆LB◆◆RB◆ A \in \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆
$$
...
$$
T_\# \mu(B) = \mu(T^◆LB◆-1◆RB◆(B)) \quad \mathrm◆LB◆for all ◆LB◆◆RB◆ B \in \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆_2
$$
...
\delta_x(A) = \begin◆LB◆cases◆RB◆
 1 & \mathrm◆LB◆if ◆LB◆◆RB◆ x\in A\\
 0 & \mathrm◆LB◆if ◆LB◆◆RB◆ x\notin A
\end◆LB◆cases◆RB◆
$$
...
$\mu$Denoted $\mathrm◆LB◆supp◆LB◆◆RB◆(\mu)$Is the set of all points $x \in S$ for which every open
neighborhood of $x$ has positive measure. Equivalently, it is the intersection of all closed sets
with full measure:

$$
\mathrm◆LB◆supp◆LB◆◆RB◆(\mu) = \bigcap \{ C \subseteq S : C \mathrm◆LB◆ is closed and ◆LB◆◆RB◆ \mu(C) = 1 \}
$$
...
1_A(\omega) =
\begin◆LB◆cases◆RB◆
 1 & \mathrm◆LB◆if ◆LB◆◆RB◆ \omega \in A\\
 0 & \mathrm◆LB◆else◆LB◆◆RB◆
\end◆LB◆cases◆RB◆
$$
...
$$
\mathrm◆LB◆Var◆LB◆◆RB◆(X) = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[(X - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X])^2] = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X^2] - (\mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X])^2
$$

The **standard deviation** is $\sigma_X = \sqrt◆LB◆\mathrm◆LB◆Var◆LB◆◆RB◆(X)◆RB◆$.

_Properties:_

- $\mathrm◆LB◆Var◆LB◆◆RB◆(X) \geq 0$
- $\mathrm◆LB◆Var◆LB◆◆RB◆(aX + b) = a^2 \mathrm◆LB◆Var◆LB◆◆RB◆(X)$ for constants $a, b$
- $\mathrm◆LB◆Var◆LB◆◆RB◆(X) = 0 \iff X = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X]$ almost surely
...
$$\mathrm◆LB◆Cov◆LB◆◆RB◆(X, Y) = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[(X - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X])(Y - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[Y])]$$

Equivalently, $\mathrm◆LB◆Cov◆LB◆◆RB◆(X, Y) = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[XY] - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X]\mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[Y]$.

_Properties:_

- $\mathrm◆LB◆Cov◆LB◆◆RB◆(X, X) = \mathrm◆LB◆Var◆LB◆◆RB◆(X)$
- $\mathrm◆LB◆Cov◆LB◆◆RB◆(X, Y) = \mathrm◆LB◆Cov◆LB◆◆RB◆(Y, X)$ (symmetry)
- $\mathrm◆LB◆Cov◆LB◆◆RB◆(aX, bY) = ab \cdot \mathrm◆LB◆Cov◆LB◆◆RB◆(X, Y)$ (bilinearity)
- If $X$ and $Y$ are independent, $\mathrm◆LB◆Cov◆LB◆◆RB◆(X, Y) = 0$ (but converse is not true)
...
$$
\Sigma = \mathrm◆LB◆Cov◆LB◆◆RB◆(\mathbf◆LB◆◆LB◆'◆RB◆X◆LB◆◆RB◆'◆RB◆) = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆\left[(\mathbf◆LB◆◆LB◆'◆RB◆X◆LB◆◆RB◆'◆RB◆ - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[\mathbf◆LB◆◆LB◆'◆RB◆X◆LB◆◆RB◆'◆RB◆])(\mathbf◆LB◆◆LB◆'◆RB◆X◆LB◆◆RB◆'◆RB◆ - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[\mathbf◆LB◆◆LB◆'◆RB◆X◆LB◆◆RB◆'◆RB◆])^\top\right]
$$

The $(i,j)$-th entry is $\Sigma_◆LB◆ij◆RB◆ = \mathrm◆LB◆Cov◆LB◆◆RB◆(X_i, X_j)$. The covariance matrix is symmetric
...
\mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆_s \subseteq \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆_t \subseteq \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆ \quad \mathrm◆LB◆for all
◆LB◆◆RB◆ s \leq t
...
\mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆[X_t | \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆_s] = X_s \quad \mathrm◆LB◆for all ◆LB◆◆RB◆ s \leq t
...
\begin◆LB◆equation◆RB◆ L*s(\theta) = f*\theta(s), \quad \mathrm◆LB◆where ◆LB◆◆RB◆ f*\theta =
...
- $\mathrm◆LB◆Cov◆LB◆◆RB◆(s(x; \theta)) = \mathcal◆LB◆◆LB◆'◆RB◆I◆LB◆◆RB◆'◆RB◆(\theta)$ (Fisher Information Matrix)
...
$$
\mathrm◆LB◆MMD◆LB◆◆RB◆(P, Q) = \sup_◆LB◆f \in \mathcal◆LB◆◆LB◆'◆RB◆F◆LB◆◆RB◆'◆RB◆◆RB◆ \left( \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆_◆LB◆x \sim P◆RB◆[f(x)] - \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆_◆LB◆y \sim Q◆RB◆[f(y)] \right)
$$
...
functions of two distributions. For data distribution $p_◆LB◆\mathrm◆LB◆data◆LB◆◆RB◆◆RB◆$ and model distribution
$p_\theta$:

$$
J(\theta) = \mathbb◆LB◆◆LB◆'◆RB◆E◆LB◆◆RB◆'◆RB◆_◆LB◆p_◆LB◆\mathrm◆LB◆data◆LB◆◆RB◆◆RB◆◆RB◆\left[ \lVert \nabla_x \log p_◆LB◆\mathrm◆LB◆data◆LB◆◆RB◆◆RB◆(x) - \nabla_x \log p_\theta(x) \rVert^2 \right]
$$
...
$\dim(\mathcal◆LB◆◆LB◆'◆RB◆M◆LB◆◆RB◆'◆RB◆) \ll d$. Formally, $\mathrm◆LB◆supp◆LB◆◆RB◆(P_◆LB◆data◆RB◆) \subseteq \mathcal◆LB◆◆LB◆'◆RB◆M◆LB◆◆RB◆'◆RB◆$.
