...
description:
  'Git object lifecycle: loose and packed objects, packfile format, delta compression, garbage
  collection, and optimisation strategies for repository maintenance.'
