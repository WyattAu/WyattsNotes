...
description: "Git version control: Advanced Git Commands — git replace; Basic Syntax; Replace one object with another; Replace using an edited version of the original."
