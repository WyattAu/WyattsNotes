...
A single EPSP is insufficient to reach threshold at the axon hillock. Multiple EPSPs must be
Summed:
...
$+67\;\mathrm{mV}$. In practice, the peak is around $+40\;\mathrm{mV}$ because the
...
Of the same diameter. For a $10\;\mathrm{\mu m}$ myelinated axon, conduction velocity is 
...
Who are aware of and frustrated by their difficulty.
