...
- **For**: potential to treat currently incurable diseases (Parkinson's, diabetes, spinal cord injury);
 the embryos used are surplus IVF embryos that would otherwise be destroyed; the potential
...
**Integral (transmembrane) proteins**: span the entire membrane, with hydrophobic regions (
