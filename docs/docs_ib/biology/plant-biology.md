...
Pressure ( $0.1$--$0.5\;\mathrm{MPa}$) provides a minor additional contribution.
...
The plant (it precipitates as insoluble compounds in older tissues and cannot be remobilised).
