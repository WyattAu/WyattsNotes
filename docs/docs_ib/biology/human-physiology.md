...
- **Hydrochloric acid** ($\mathrm{HCl}$PH $\approx 1.5$--$2.0$): denatures proteins, kills
 ingested microorganisms, provides optimal pH for pepsin.
...
- The curve shifts right (lower affinity, more unloading) with increased $\mathrm{CO}_2$Decreased
 pH (Bohr effect), increased temperature, and increased $23$-BPG (produced in active tissues).
