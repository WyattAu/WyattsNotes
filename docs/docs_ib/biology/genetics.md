...
3. Introduce the recombinant plasmid into _Agrobacterium tumefaciens_ (which naturally transfers
...
that initiate recombination. The number of chiasmata per bivalent varies (typically 1--3 in humans).
