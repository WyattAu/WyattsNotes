...
- **DNA structure and mutations**: Review [./molecular-biology](./molecular-biology) for DNA
...
- **Advanced genetics and genetic engineering**: Review [./genetics-advanced](./genetics-advanced)
  for DNA technology, CRISPR, and detailed molecular mechanisms.
...
- **Cell biology and chromosomes**: Review [./cell-biology](./cell-biology) for mitosis, meiosis,
  and chromosome structure.
- **Immunology and genetics**: Review [./immunology](./immunology) for antibody genetics and blood
  type inheritance.
