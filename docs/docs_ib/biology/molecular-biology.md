...
2. **Elongation**:
 ...
 - The ribosome **translocates** by one codon: the empty tRNA moves to the **E site** (exit site)
 and is released; the tRNA carrying the growing polypeptide moves from the A site to the P site.
...
Inhibition. (c) Explain why statins are taken at night, relating this to the diurnal
