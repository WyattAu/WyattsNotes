...
export const flashcard2 = [
  ...
  {
    id: 'genetics-1',
    front: "State Mendel's Law of Segregation and Law of Independent Assortment.", back: 'Law of Segregation: allele pairs separate during gamete formation (meiosis), so each gamete carries only one allele for each gene. Law of Independent Assortment: alleles of different genes assort independently during gamete formation (provided genes are on different chromosomes or far apart). These laws form the basis of Mendelian inheritance and predict genotypic/phenotypic ratios in crosses.', tags: ['genetics', "Mendel's laws"],
    difficulty: 'medium',
  },
  {
    id: 'genetics-2',
