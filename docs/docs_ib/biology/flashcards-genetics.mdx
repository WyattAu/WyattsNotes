...
categories:
  - IB Biology
description:
  'Interactive flashcards for IB Biology genetics. Test your knowledge of DNA structure,
  protein synthesis, inheritance, biotechnology, and evolution with spaced repetition.'
---
...
15 flashcards covering IB Biology genetics — DNA structure, protein synthesis, Mendelian genetics, biotechnology, and evolution.
...
<FlashcardDeck
  ...
  cards={[
    ...
    {
      id: 'biotech-3',
      front: 'Describe the steps involved in genetic engineering using restriction enzymes and vectors.',
