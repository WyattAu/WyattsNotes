...
- **Intrasexual selection**: competition within one sex ( males) for access to mates. Leads
...
- Most morphological change occurs during the speciation event ( in small, isolated
...
- **Rooted tree**: includes a common ancestor and shows the direction of evolution ( rooted
...
The geographic distribution of species reflects evolutionary history. Species on oceanic islands are
 more similar to species on the nearest mainland than to species on other islands (despite
