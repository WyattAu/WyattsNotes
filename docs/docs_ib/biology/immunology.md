...
title: Immunology
description:
  'IB Biology — innate immunity, adaptive immunity, antibody structure and classes, T-cell and
  B-cell activation, immunological memory, vaccines, ELISA,'
slug: immunology
---
...
- **Cell membrane and receptor proteins**: Review [./cell-biology](./cell-biology) for membrane
  protein structure and signalling.
- **Protein structure and antibodies**: Review [./molecular-biology](./molecular-biology) for
  immunoglobulin structure and antigen binding.
- **Genetics and V(D)J recombination**: Review [./genetics](./genetics) for antibody diversity
  generation.
- **Human physiology -- blood and circulation**: Review [./human-physiology](./human-physiology) for
  blood cell types and circulatory pathways.
- **Molecular biology -- DNA technology**: Review [./genetics-advanced](./genetics-advanced) for
