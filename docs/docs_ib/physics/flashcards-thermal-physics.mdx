...
const flashcardData = [
  ...
  },
  {
    ...
    back: "1) The gas consists of a large number of small molecules in random motion.\n2) Molecules are point particles — their volume is negligible compared to the container.\n3) No intermolecular forces act except during collisions.\n4) All collisions are perfectly elastic (KE conserved).\n5) The duration of collisions is negligible compared to time between collisions.\n6) Molecules obey Newton's laws of motion.",
  ...
  },
  {
    ...
    back: "Charles's law: at constant pressure, V ∝ T (V/T = constant). When heated at constant P, gas must expand. Microscopic: molecules move faster at higher T, exerting more force on walls; to keep P constant, V must increase to reduce collision frequency.\nGay-Lussac's law: at constant volume, P ∝ T (P/T = constant). Faster molecules collide harder and more often with fixed walls, increasing pressure.",
    tags: ['thermal', 'gas laws'],
    difficulty: 'medium',
  },
  {
    ...
    back: 'Heating water from −20 °C to 120 °C:\n1) Ice warms: Q = mc_ice × ΔT (c_ice = 2100 J kg⁻¹ K⁻¹)\n2) Melting at 0 °C: Q = mL_f (temperature constant, L_f = 3.34 × 10⁵ J kg⁻¹)\n3) Water warms: Q = mc_water × ΔT (c_water = 4180 J kg⁻¹ K⁻¹)\n4) Boiling at 100 °C: Q = mL_v (temperature constant, L_v = 2.26 × 10⁶ J kg⁻¹)\n5) Steam warms: Q = mc_steam × ΔT (c_steam ≈ 2010 J kg⁻¹ K⁻¹)',
