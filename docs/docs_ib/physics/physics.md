...
3. **Wave Phenomena (C.2--C.4):** Double-slit interference, single-slit diffraction, Snell's law,
 standing waves in strings and pipes. Tested with both conceptual and calculation
 questions.
...
> **Exam Tip:** An "Explain" question requires a chain of reasoning with 2--3 linked
...
- **Significant figures:** IB expects answers to be given to the same number of significant figures
 as the least precise data in the question ( 2--3 sf). Dropping to 1 sf or using 5+ sf will
 lose marks.
...
- **Activity vs count rate:** Activity $A$ is the number of decays per second in the sample;
 ...
 detector efficiency and geometry. IB questions specify which is being asked.
