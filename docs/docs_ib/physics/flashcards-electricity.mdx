...
const flashcardData = [
  ...
  },
  {
    ...
    back: '1) Current is the same through all components: I_total = I₁ = I₂ = ...\n2) Total voltage equals sum of individual voltages: V_total = V₁ + V₂ + ...\n3) Total resistance equals sum of individual resistances: R_total = R₁ + R₂ + ...\n4) If one component fails, the entire circuit is broken (no current flows).\n5) Adding more resistors increases total resistance.',
  ...
  },
  {
    ...
    back: '1) Voltage is the same across all branches: V_total = V₁ = V₂ = ...\n2) Total current equals sum of branch currents: I_total = I₁ + I₂ + ...\n3) 1/R_total = 1/R₁ + 1/R₂ + ... (total resistance is LESS than smallest individual resistor)\n4) If one branch fails, other branches continue to work.\n5) Adding more parallel resistors decreases total resistance (more paths for current).',
    tags: ['electricity', 'circuits'],
    difficulty: 'medium',
  },
  {
