...
const flashcardData = [
  ...
  },
  {
    ...
    back: 'All require constant acceleration a and straight-line motion:\n1) v = u + at (missing s)\n2) s = ut + ½at² (missing v)\n3) v² = u² + 2as (missing t)\n4) s = ½(u + v)t (missing a)\n5) s = vt − ½at² (missing u)\nChoose based on which variable is unknown. u = initial velocity, v = final velocity, s = displacement, a = acceleration, t = time.',
  ...
  },
  {
    ...
    back: 'Projectile motion is the motion of an object launched into the air, subject only to gravity. Analyse by resolving into horizontal and vertical components:\nHorizontal: constant velocity (no acceleration, neglecting air resistance), x = u cos θ × t.\nVertical: uniform acceleration g, use SUVAT equations with a = −9.81 m s⁻¹.\nThe two components are independent — horizontal motion does not affect vertical motion.',
  ...
  },
  {
    ...
    back: 'Launched at speed u, angle θ from level ground:\nMax height: H = (u sin θ)² / (2g)\nTime of flight: T = 2u sin θ / g\nHorizontal range: R = u² sin(2θ) / g\nMaximum range occurs at θ = 45°. Complementary angles (θ and 90° − θ) give the same range.',
    tags: ['kinematics', 'projectile motion'],
    difficulty: 'medium',
  },
  {
  ...
  },
  {
    ...
    back: 'From v = u + at: t = (v − u)/a. Substitute into s = ut + ½at²:\ns = u(v − u)/a + ½a((v − u)/a)²\ns = (uv − u²)/a + (v² − 2uv + u²)/(2a)\nMultiply by 2a: 2as = 2uv − 2u² + v² − 2uv + u² = v² − u²\nTherefore: v² = u² + 2as.',
...
<FlashcardDeck
  deckId="ib-phys-kinematics"
  title="IB Physics: Kinematics"
  description="Scalars, vectors, SUVAT equations, projectile motion, free fall, terminal velocity, and graph interpretation."
  cards={flashcardData}
/>;
