...
description: "Hardest IB Physics energy diagnostic tests covering path-dependent friction work, elastic collisions with energy conservation, power with variable forces, and"
slug: diag-energy
