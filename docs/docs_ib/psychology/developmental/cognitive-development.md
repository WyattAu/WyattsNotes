...
description:
  "Comprehensive coverage of Piaget's stages, Vygotsky's sociocultural theory, theory of mind, moral
  development, brain development, and key research for IB Psychology."
...
- Typically developing children aged 4 and older correctly answer that Sally will look in her basket
  (understanding that Sally holds a false belief -- she does not know that Anne moved the marble).
- Children with autism aged 4 and older typically answer that Sally will look in the box (failing
  the false belief task, suggesting a deficit in theory of mind).
- Typically developing 3-year-olds typically fail the task.
...
- **Stage 6: Universal ethical principles.** Moral behaviour is determined by self-chosen ethical
  principles (e.g., justice, equality, human dignity) that are universal and in some cases transcend
  specific laws.
...
<details>
<summary>Common Pitfalls: Cognitive Development</summary>
