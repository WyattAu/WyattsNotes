...
description: Comprehensive coverage of qualitative research methods for IB Psychology HL, including paradigm differences, interviews, observations, content analysis, case studies, and triangulation.
...
- **Qualitative methods and the cognitive LOA:** Thematic analysis can be used to analyse interview data about memory experiences or cognitive processes, complementing the experimental methods discussed in the [Cognitive Level of Analysis](./cognitive-level-of-analysis).
