...
The strong version has been largely discredited by empirical evidence. People are capable of
...
2. Describing a study without evaluating its methodology (e.g., sample, controls, ecological
   validity).
