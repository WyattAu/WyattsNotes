...
categories:
  - IB Chemistry
description:
  'Interactive flashcards for IB Chemistry quantitative chemistry covering mole concept, Avogadro, molar mass,
  empirical and molecular formulas, limiting reactants, yield, gas laws, and titration calculations.'
---
...
<FlashcardDeck
  ...
  cards={[
    ...
    },
    {
      ...
      front: 'A mixture contains Na2CO3 and NaHCO3. Explain how to determine the composition using titration with HCl.',
    ...
    },
    {
      ...
      front: 'How do you combine Avogadro\'s law, Boyle\'s law, and Charles\'s law into the combined gas equation?',
    ...
    },
    {
      ...
      front: 'A student performs an experiment to determine the molar mass of a volatile liquid. Describe the Dumas method calculation.',
