...
categories:
  - IB Chemistry
description:
  'Interactive flashcards for IB Chemistry redox and electrochemistry covering oxidation states, half-equations,
  standard electrode potentials, electrochemical cells, electrolysis, and Faraday\'s laws.'
---
...
<FlashcardDeck
  ...
  cards={[
    ...
    },
    {
      ...
      front: 'Describe the structure and operation of a voltaic (galvanic) cell. Use Zn-Cu as an example.',
    ...
    },
    {
      ...
      front: 'How can you use standard electrode potentials to predict if a redox reaction is spontaneous?',
    ...
    },
    {
      ...
      front: 'How do you predict the products of electrolysis of aqueous CuSO4 using inert (platinum) electrodes?',
    ...
    },
    {
      ...
      front: 'Explain how to determine the oxidation state of an element in a complex ion such as Cr2O7 2-.',
    ...
    },
    {
      ...
      front: 'Balance the redox equation: Cr2O7 2- + Fe2+ + H+ -> Cr3+ + Fe3+ + H2O in acidic solution.',
    ...
    },
    {
      ...
      front: 'Explain disproportionation using chlorine as an example. How do you identify if disproportionation occurs?',
    ...
    },
    {
      ...
      front: 'Calculate the mass of copper deposited when a current of 2.50 A is passed through CuSO4 solution for 45.0 minutes. (M(Cu) = 63.5 g mol-1)',
    ...
    },
    {
      ...
      front: 'Explain how to use the electrochemical series to predict reactions between halogens and halide ions.',
