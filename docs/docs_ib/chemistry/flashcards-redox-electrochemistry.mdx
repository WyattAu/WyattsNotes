...
<FlashcardDeck
  ...
  cards={[
    ...
    },
    {
      ...
      front:
        'How do you write and balance a half-equation for a redox reaction in acidic solution?',
    ...
    },
    {
      ...
      front:
        'How do you calculate the standard cell potential (Ecell) for an electrochemical cell?',
