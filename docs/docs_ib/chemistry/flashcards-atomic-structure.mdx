...
categories:
  - IB Chemistry
description:
  'Interactive flashcards for IB Chemistry atomic structure. Test your knowledge of atomic models, subatomic particles, isotopes, mass spectrometry, electron configurations, and periodic trends.'
---
...
<FlashcardDeck
  ...
  cards={[
    ...
    },
    {
      ...
      front: 'Write the electron configuration for iron (Fe, Z=26) and identify the 3d and 4s subshell filling.',
    ...
    },
    {
      ...
      front: 'Explain the relationship between successive ionization energies and electron configuration.',
