...
distance (typically 400--800 m, or a 5--10 minute walk) of high-quality public transport nodes
(metro stations, BRT stations, major bus interchanges). Key principles include:
