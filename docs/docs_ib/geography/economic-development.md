...
description: Development indicators, theories of development, globalisation, TNCs, trade, and development strategies for IB Geography.
...
The World Bank classifies countries by GNI per capita (2023 thresholds): low income ($\lt{1145}$), lower-middle income ($1145$--$4465), upper-middle income ($4466$--$13 845), and high income ($\gt{13 845}$).
...
1. **Overly deterministic.** The theory leaves little room for agency on the part of developing countries. Some countries (e.g., South Korea, Taiwan, Singapore) have achieved rapid development despite being former colonies and deeply integrated into the global economy.
2. **Does not explain East Asian success.** The "Asian Tigers" developed precisely through export-oriented industrialisation and integration into global markets, which dependency theory would predict should deepen underdevelopment.
3. **Ignores internal factors.** Dependency theory focuses on external constraints but downplays the role of domestic governance, corruption, and institutional quality.
...
1. **Technological advances:** containerisation (standardised shipping containers reduced transport costs by approximately 80% between 1960 and 2000), the internet, and telecommunications have dramatically reduced the cost of transmitting information and goods across distances.
2. **Deregulation and liberalisation:** the removal of trade barriers (GATT/WTO rounds, bilateral free trade agreements), capital controls, and foreign ownership restrictions since the 1980s has facilitated the flow of goods, capital, and services.
3. **Transport improvements:** the expansion of air freight, high-speed rail, and maritime shipping has reduced transit times and costs.
4. **Institutional frameworks:** international organisations (WTO, IMF, World Bank) and regional blocs (EU, ASEAN, NAFTA/USMCA) have created rules-based frameworks for economic integration.
...
- **Growth trajectory:** GDP per capita increased from approximately US$150 in 1978 to over US$12 500 in 2023 (at current prices). Over 800 million people were lifted out of extreme poverty between 1981 and 2020.
