...
export const flashcard1 = [
  ...
  },
  {
    ...
    back: "If f'(a) = 0: f''(a) > 0 → local minimum at x = a; f''(a) < 0 → local maximum at x = a; f''(a) = 0 → test is inconclusive (use first derivative test or higher derivatives).", tags: ['differentiation', 'applications'], difficulty: 'medium', },
];
