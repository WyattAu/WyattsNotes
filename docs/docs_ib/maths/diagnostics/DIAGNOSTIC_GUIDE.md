...
This document defines the diagnostic testing framework for IB Mathematics. The Diagnostic tests are
the hardest questions within the specification, designed to Determine whether a student has genuine
understanding of a topic rather than Surface-level familiarity. They are not practice quizzes for
beginners.
...
Single-source-of-truth view of your strengths and weaknesses across all 14 IB Mathematics topics.
...
- The difficulty level corresponds to the top band of exam mark schemes (7/7 on IB Paper 2
  questions).
