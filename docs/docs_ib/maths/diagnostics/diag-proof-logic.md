...
**(b)** The correct approach: since $n^3 + 5n$ is even for all $n \in \mathbb{'\{'}Z{'\}'}$ (as
shown above), the statement "if $n^3 + 5n$ is even, then $n$ is even" is **false**. A counterexample
is $n = 1$: $1 + 5 = 6$ is even, but $n = 1$ is odd.
