...
$$
P(\text{both red}) = P(\text{first red}) \cdot P(\text{second red} | \text{first red}) = \frac{5}{8} \cdot \frac{4}{7} = \frac{20}{56} = \frac{5}{14}
$$
...
$$
P(\text{exactly one defective}) = \frac{24}{90} + \frac{24}{90} = \frac{48}{90} = \frac{8}{15}
$$
...
$$
P(\text{defective}) = 0.5 \times 0.02 + 0.3 \times 0.03 + 0.2 \times 0.01 = 0.01 + 0.009 + 0.002 = 0.021
$$

$$
P(B|\text{defective}) = \frac{0.3 \times 0.03}{0.021} = \frac{0.009}{0.021} = \frac{3}{7}
$$
...
($P(\text{positive}|\text{disease}) = 0.99$) and 95% specificity
($P(\text{negative}|\text{no disease}) = 0.95$). What is $P(\text{disease}|\text{positive})$?

$$
P(\text{positive}) = 0.01 \times 0.99 + 0.99 \times 0.05 = 0.0099 + 0.0495 = 0.0594
$$

$$
P(\text{disease}|\text{positive}) = \frac{0.01 \times 0.99}{0.0594} = \frac{0.0099}{0.0594} \approx 0.167
$$
...
2. $\displaystyle\sum_{\text{all } i} p_i = 1$
...
$$
x = 170 + 1.282 \times 8 = 170 + 10.26 = 180.26 \text{ cm}
$$
...
$$
x = 45 - 1.282 \times 8 = 45 - 10.26 = 34.74 \text{ minutes}
$$
...
$X \sim \text{Po}(\lambda)$ where $\lambda$ is the mean number of events.
...
$X \sim \text{Geo}(p)$ where $p$ is the probability of success on each trial.
...
The heights of Year 12 students follow a normal distribution with mean $165\text{ cm}$ and standard
deviation $8\text{ cm}$.

**(a)** What percentage of students are taller than $180\text{ cm}$?
...
5th percentile: $\dfrac{h - 165}{8} = -1.645 \implies h = 165 - 13.16 = 151.8\text{ cm}$.

95th percentile: $\dfrac{h - 165}{8} = 1.645 \implies h = 165 + 13.16 = 178.2\text{ cm}$.

Desks should accommodate heights from about $152\text{ cm}$ to $178\text{ cm}$.
