...
<DiagnosticTest subject="IB Economics" questions={questions} onComplete={handleComplete} />
...
| ----------------------- | --------- | ------------------------------------------------------------------------ |
| Microeconomics          | 4         | [Microeconomics](/docs/ib/economics/1-microeconomics/)                   |
| Macroeconomics          | 4         | [Macroeconomics](/docs/ib/economics/2-macroeconomics/)                   |
| International Economics | 4         | [International Economics](/docs/ib/economics/3-international-economics/) |
| Development Economics   | 3         | [Development Economics](/docs/ib/economics/4-development-economics/)     |
| Quantitative Economics  | 3         | [Quantitative Economics](/docs/ib/economics/5-quantitative-economics/)   |
| Game Theory             | 2         | [Game Theory](/docs/ib/economics/6-game-theory/)                         |
