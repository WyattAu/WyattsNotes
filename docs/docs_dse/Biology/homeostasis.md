...
(a) Calculate the mass of glucose filtered per day.
(b) Calculate the mass of glucose reabsorbed per day.
(c) Calculate the mass of glucose excreted in urine per day.
(d) Explain why this patient produces large volumes of urine.
