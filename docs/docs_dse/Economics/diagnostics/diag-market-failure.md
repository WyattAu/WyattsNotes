...
(c) Pigouvian tax $= MEC = 20$ cents. New supply: $P = 60 + Q$. New equilibrium: $200 - Q = 60 + Q$, $Q = 70$, $P_{b} = \$1.30$, $P_{s} = \$1.10$.
...
Post-tax: $200 - 0.5Q = 60 + Q$, $1.5Q = 140$, $Q_t = 93.33$, $P_{b} = 153.33$, $P_{s} = 133.33$.
