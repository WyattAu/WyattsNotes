...
Influences the real economy. This process operates with lags ( 12-18 months for the full
...
Crowding out from fiscal policy). The net effect on inflation is ambiguous -- on which
Policy is stronger.
