...
Since demand curves slope downward, PED is negative. By convention, we often report the
**absolute value**.
...
- When analysing taxes and subsidies, identify who pays and who receives, and calculate the
 burden on each side.
...
(b) Supply B is more elastic (flatter slope coefficient 5 vs 3), meaning producers are more responsive to price changes. With more elastic supply, producers bear a smaller share of the tax (28.6% vs 40%) because they can more reduce quantity in response to the lower net price. Consumers bear a larger share because they are relatively less responsive (same demand curve in both scenarios).
