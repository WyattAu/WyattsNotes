...
:::tip Diagnostic Test
Ready to test your understanding of **Geometries**? The [diagnostic test](/Maths/diagnostics/diag-geometries) contains the hardest questions within the DSE specification for this topic, each with a full worked solution.
