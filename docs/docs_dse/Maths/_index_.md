...
description:
  ...
  geometry, trigonometry, probability, statistics, and'
slug: maths
...
worked examples, common pitfalls, and exam-style problems. All topics are structured for systematic
revision and drill practice.
...
- **[Combinatorics](./compulsory/combinatorics)** -- Permutations, combinations, counting
  principles, binomial theorem, and probability applications
