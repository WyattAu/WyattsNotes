...
See [./forces-and-motion](./forces-and-motion) for detailed notes.
...
See [./waves-and-sound](./waves-and-sound) for detailed notes.
...
See [./electrical-circuits](./electrical-circuits) and [./magnetism-and-electromagnetism](./magnetism-and-electromagnetism) for detailed notes.
...
**Problem 1.** A stone is thrown vertically upward with initial speed $15 \mathrm{ m/s}$.
Find the maximum height reached and the total time in the air.
