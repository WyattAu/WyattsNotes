...
This is an increase of $\frac{18\,939 - 18182}{18\,182} \times 100\% = 4.2\%$ in real terms. The
worker's purchasing power has genuinely improved because the nominal salary increase (25%) exceeded
inflation (20%).
