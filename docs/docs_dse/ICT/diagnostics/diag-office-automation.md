...
statistics and charts. (3) **Word processor** uses a template with placeholders (student name,
grades, teacher comments) and pulls data from the spreadsheet via mail merge to generate
individualised report cards.
