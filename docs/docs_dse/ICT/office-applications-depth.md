...
Spreadsheet functions, deeper database operations, and detailed coverage of presentation software
and Desktop publishing for the DSE ICT practical examination.
