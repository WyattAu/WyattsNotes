...
These diagnostic tests target the **hardest** questions within the HKDSE Biology specification. Each
test is designed to expose deep misconceptions that separate top-tier candidates from the rest.
...
3. `diag-human-physiology.md` -- Nutrition, respiration, gas exchange, circulatory system, nervous
   system
4. `diag-human-reproduction-homeostasis.md` -- Reproductive systems, menstrual cycle, homeostasis,
   immune system
5. `diag-genetics.md` -- DNA structure, protein synthesis, inheritance patterns, genetic engineering
6. `diag-evolution-ecology.md` -- Natural selection, speciation, ecosystems, nutrient cycles, human
   impact
