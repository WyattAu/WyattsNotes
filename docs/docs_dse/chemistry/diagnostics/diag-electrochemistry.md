...
(c) How would the products change if **dilute** aqueous sodium chloride were electrolysed instead?
Explain. [3 marks]
...
(a) **Cathode (negative electrode)**: $Na^{+}$ and $H_{2}O$ are present. $H_{2}O$ is reduced in
...
**Anode (positive electrode)**: $Cl^{-}$ and $H_{2}O$ are present. In **concentrated** $NaCl$
...
- **Cathode**: Same as before -- $H_{2}O$ is still reduced to $H_{2}$ (since $Na^{+}$ is never
