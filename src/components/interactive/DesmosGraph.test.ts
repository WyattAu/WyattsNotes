...
import { parseExpression } from '../../components/interactive/DesmosGraph';

// Import the parseExpression function by extracting it from the module
// Since it's not exported, we test the component behavior instead
...
describe('DesmosGraph', () => {
  ...
  describe('DesmosGraph component rendering', () => {
    it('should return null when no expressions and no calculatorUrl', () => {
      // This tests the guard clause: expressions.length === 0 && !calculatorUrl
