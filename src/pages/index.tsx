...
function HomepageHeader() {
  ...
  const navItems: NavigationItem[] = [
    ...
    },
    {
      ...
      items: [
        { label: 'C++ Notes', to: '/docs_cpp-notes/intro' },
        { label: 'Dart Notes', to: '/docs_dart-notes/intro' },
        { label: 'Java Notes', to: '/docs_java-notes/intro' },
        { label: 'Python Notes', to: '/docs_python-notes/intro' },
        { label: 'Git Notes', to: '/docs_git-notes/intro' },
      ],
    },
    {
      type: 'group',
      label: 'Operating System',
      items: [{ label: 'TrueNAS', to: '/docs_truenas-notes/intro' }],
    },
    {
      type: 'group',
      label: 'Others',
      items: [
        { label: 'Licensing Notes', to: '/docs_licensing-notes/intro' },
        { label: 'Tuning', to: '/docs_tuning-notes/intro' },
        { label: 'Contributing Help', to: '/docs_general-notes/intro' },
      ],
    },
  ];
