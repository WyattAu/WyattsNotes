...
const subjectGroups: SubjectGroup[] = [
  {
    ...
    subjects: [
      ...
      },
      {
        ...
        files: 115,
        lines: '61.7K',
        href: '/docs/academics/alevel/intro',
        tag: 'A*',
    ...
    subjects: [
      {
        ...
        files: 122,
        lines: '62.7K',
        href: '/docs/programming/cpp/intro',
        tag: 'C++20/23',
      ...
      },
      {
        ...
        files: 25,
        lines: '23.3K',
        href: '/docs/programming/java/intro',
        tag: 'JDK 21+',
      ...
      },
      {
        ...
        files: 26,
        lines: '26.2K',
        href: '/docs/programming/python/intro',
        tag: '3.12+',
      ...
      },
      {
        ...
        files: 17,
        lines: '15.9K',
        href: '/docs/programming/rust/intro',
        tag: '2024',
      ...
      },
      {
        ...
        files: 21,
        lines: '18.3K',
        href: '/docs/programming/dart/intro',
        tag: 'Flutter',
    ...
    subjects: [
      {
        ...
        files: 19,
        lines: '17.2K',
        href: '/docs/infrastructure/linux/intro',
        tag: 'POSIX',
      ...
      },
      {
        ...
        files: 20,
        lines: '17.3K',
        href: '/docs/infrastructure/networking/intro',
        tag: 'TCP/IP',
      ...
      },
      {
        ...
        files: 15,
        lines: '13.6K',
        href: '/docs/infrastructure/databases/intro',
        tag: 'SQL',
      ...
      },
      {
        ...
        files: 17,
        lines: '13.8K',
        href: '/docs/infrastructure/security/intro',
        tag: 'InfoSec',
      ...
      },
      {
        ...
        files: 11,
        lines: '8.6K',
        href: '/docs/infrastructure/truenas/intro',
        tag: 'NAS',
      ...
      },
      {
        ...
        files: 9,
        lines: '7.8K',
        href: '/docs/infrastructure/tuning/intro',
        tag: 'HW',
  ...
  },
  {
    ...
    subjects: [
      ...
      },
      {
        ...
        files: 16,
        lines: '14.2K',
        href: '/docs/tools/algorithms/intro',
        tag: 'CS',
      ...
      },
      {
        ...
        files: 3,
        lines: '1.7K',
        href: '/docs/tools/probabilisticml/intro',
        tag: 'Grad-level',
      ...
      },
      {
        ...
        files: 2,
        lines: '1.1K',
        href: '/docs/tools/licensing/intro',
        tag: 'Legal',
...
const totalFiles = 584;
const totalLines = '398K';
