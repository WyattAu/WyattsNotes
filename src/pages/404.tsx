...
const subjects: Subject[] = [
  ...
  { name: 'C++', href: '/docs/programming/cpp/intro', tag: 'C++20/23' },
  { name: 'Java', href: '/docs/programming/java/intro', tag: 'JDK 21+' },
  { name: 'Python', href: '/docs/programming/python/intro', tag: '3.12+' },
  { name: 'Rust', href: '/docs/programming/rust/intro', tag: '2024' },
  { name: 'Dart', href: '/docs/programming/dart/intro', tag: 'Flutter' },
